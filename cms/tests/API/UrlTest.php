...
class UrlTest extends TestCase
{
    ...
    {
        Config::set('system.locales.en.url', 'http://site.com/');
    ...
    {
        Config::set('system.locales.en.url', 'http://site.com/index.php/');
    ...
    {
        Config::set('system.locales.en.url', 'http://this-site.com/');
