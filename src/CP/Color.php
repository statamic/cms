...
class Color
{
    ...
    public static function defaults(bool $dark = false): array
    {
        return collect([
            ...
            'dark-chart-4-label-bg' => self::Orange[600],
            ...
            // Dusk Meadow chart theme
            // 'chart-1' => self::Indigo[500],
            // 'chart-2' => self::Zinc[800],
            // 'chart-3' => self::Lime[500],
            // 'chart-4' => self::Orange[400],
            // 'dark-chart-1' => self::Indigo[600],
            // 'dark-chart-2' => self::Indigo[200],
            // 'dark-chart-3' => self::Lime[500],
            // 'dark-chart-4' => self::Orange[500],
            ...
            // 'chart-2-label-bg' => self::Transparent,
            // 'chart-3-label-bg' => self::Lime[600],
            // 'chart-4-label-bg' => self::Orange[500],
            // 'dark-chart-1-label-bg' => self::Indigo[700],
            // 'dark-chart-2-label-bg' => self::Indigo[400],
            // 'dark-chart-3-label-bg' => self::Lime[600],
            // 'dark-chart-4-label-bg' => self::Orange[600],
            ...
            // 'chart-2-legend' => self::Zinc[800],
            // 'chart-3-legend' => self::Lime[500],
            // 'chart-4-legend' => self::Orange[500],
            // 'dark-chart-1-legend' => self::Indigo[600],
            // 'dark-chart-2-legend' => self::Indigo[300],
            // 'dark-chart-3-legend' => self::Lime[500],
            // 'dark-chart-4-legend' => self::Orange[500],

            // Kelp Forest chart theme
            // 'chart-1' => self::Blue[500],
            // 'chart-2' => self::Zinc[800],
            // 'chart-3' => self::Lime[500],
            // 'chart-4' => self::Indigo[200],
            // 'dark-chart-1' => self::Blue[500],
            // 'dark-chart-2' => self::Blue[50],
            // 'dark-chart-3' => self::Lime[500],
            // 'dark-chart-4' => self::Blue[800],
            // 'chart-1-label-bg' => self::Blue[600],
            // 'chart-2-label-bg' => self::Transparent,
            // 'chart-3-label-bg' => self::Lime[600],
            // 'chart-4-label-bg' => self::Indigo[400],
            // 'dark-chart-1-label-bg' => self::Blue[600],
            // 'dark-chart-2-label-bg' => self::Blue[400],
            // 'dark-chart-3-label-bg' => self::Lime[600],
            // 'dark-chart-4-label-bg' => self::Blue[800],
            // 'chart-1-legend' => self::Blue[500],
            // 'chart-2-legend' => self::Zinc[800],
            // 'chart-3-legend' => self::Lime[500],
            // 'chart-4-legend' => self::Indigo[300],
            // 'dark-chart-1-legend' => self::Blue[500],
            // 'dark-chart-2-legend' => self::Blue[50],
            // 'dark-chart-3-legend' => self::Lime[500],
            // 'dark-chart-4-legend' => self::Blue[800],

            // Ocean Ridge chart theme
            // 'chart-1' => self::Blue[500],
            // 'chart-2' => self::Zinc[800],
            // 'chart-3' => self::Yellow[500],
            // 'chart-4' => self::Blue[200],
            // 'dark-chart-1' => self::Blue[600],
            // 'dark-chart-2' => self::Blue[100],
            // 'dark-chart-3' => self::Yellow[500],
            // 'dark-chart-4' => self::Blue[400],
            // 'chart-1-label-bg' => self::Blue[600],
            // 'chart-2-label-bg' => self::Transparent,
            // 'chart-3-label-bg' => self::Yellow[600],
            // 'chart-4-label-bg' => self::Blue[400],
            // 'dark-chart-1-label-bg' => self::Blue[700],
            // 'dark-chart-2-label-bg' => self::Blue[400],
            // 'dark-chart-3-label-bg' => self::Yellow[600],
            // 'dark-chart-4-label-bg' => self::Blue[600],
            // 'chart-1-legend' => self::Blue[500],
            // 'chart-2-legend' => self::Zinc[800],
            // 'chart-3-legend' => self::Yellow[500],
            // 'chart-4-legend' => self::Blue[300],
            // 'dark-chart-1-legend' => self::Blue[600],
            // 'dark-chart-2-legend' => self::Blue[100],
            // 'dark-chart-3-legend' => self::Yellow[500],
            // 'dark-chart-4-legend' => self::Blue[400],

            // Volcano chart theme
            // 'chart-1' => self::Indigo[500],
            // 'chart-2' => self::Zinc[800],
            // 'chart-3' => self::Orange[500],
            // 'chart-4' => self::Indigo[200],
            // 'dark-chart-1' => self::Indigo[600],
            // 'dark-chart-2' => self::Zinc[50],
            // 'dark-chart-3' => self::Orange[500],
            // 'dark-chart-4' => self::Indigo[300],
            // 'chart-1-label-bg' => self::Indigo[600],
            // 'chart-2-label-bg' => self::Transparent,
            // 'chart-3-label-bg' => self::Orange[600],
            // 'chart-4-label-bg' => self::Indigo[400],
            // 'dark-chart-1-label-bg' => self::Indigo[700],
            // 'dark-chart-2-label-bg' => self::Zinc[700],
            // 'dark-chart-3-label-bg' => self::Orange[600],
            // 'dark-chart-4-label-bg' => self::Indigo[500],
            // 'chart-1-legend' => self::Indigo[500],
            // 'chart-2-legend' => self::Zinc[800],
            // 'chart-3-legend' => self::Orange[500],
            // 'chart-4-legend' => self::Indigo[300],
            // 'dark-chart-1-legend' => self::Indigo[600],
            // 'dark-chart-2-legend' => self::Zinc[50],
            // 'dark-chart-3-legend' => self::Orange[500],
            // 'dark-chart-4-legend' => self::Indigo[300],
        ])
