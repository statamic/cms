...
class Color
{
    ...
    public static function defaults(bool $dark = false): array
    {
        return collect([
            ...
            'chart-5-label-bg' => self::Indigo[200],
            ...
            'dark-chart-5-legend' => self::Indigo[200],
        ])
