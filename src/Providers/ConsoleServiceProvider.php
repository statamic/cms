...
class ConsoleServiceProvider extends ServiceProvider
{
    protected $commands = [
        ...
        Commands\InstallEloquent::class,
        Commands\Eloquent\InstallEloquentCollections::class,
        Commands\Eloquent\InstallEloquentCollectionTrees::class,
        Commands\Eloquent\InstallEloquentEntries::class,
