        ...
        Blueprint::make('link')
            ...
            ->setContents([
                ...
                'fields' => [
                    ...
                    ['handle' => 'redirect_http_status', 'field' => ['type' => 'select', 'required' => true, 'options' => [301 => __('301 (Permanent)'), 302 => __('302 (Temporary)')], 'width' => '25', 'display' => __('Redirect HTTP Status')]],
                ],
            ])
            ->save();
    }
