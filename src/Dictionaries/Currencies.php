...
class Currencies extends BasicDictionary
{
    ...
    protected function getItems(): array
    {
        return [
            ...
            ['code' => 'AFN', 'name' => __('statamic::dictionary-currencies.AFN'), 'symbol' => '؋', 'decimals' => 2],
            ['code' => 'ALL', 'name' => __('statamic::dictionary-currencies.ALL'), 'symbol' => 'Lek', 'decimals' => 2],
            ['code' => 'AMD', 'name' => __('statamic::dictionary-currencies.AMD'), 'symbol' => 'դր.', 'decimals' => 2],
            ['code' => 'AOA', 'name' => __('statamic::dictionary-currencies.AOA'), 'symbol' => 'Kz', 'decimals' => 2],
            ...
            ['code' => 'AWG', 'name' => __('statamic::dictionary-currencies.AWG'), 'symbol' => 'ƒ', 'decimals' => 2],
            ...
            ['code' => 'BBD', 'name' => __('statamic::dictionary-currencies.BBD'), 'symbol' => '$', 'decimals' => 2],
            ...
            ['code' => 'BMD', 'name' => __('statamic::dictionary-currencies.BMD'), 'symbol' => '$', 'decimals' => 2],
            ...
            ['code' => 'BSD', 'name' => __('statamic::dictionary-currencies.BSD'), 'symbol' => '$', 'decimals' => 2],
            ['code' => 'BTN', 'name' => __('statamic::dictionary-currencies.BTN'), 'symbol' => 'Nu', 'decimals' => 2],
            ...
            ['code' => 'COP', 'name' => __('statamic::dictionary-currencies.COP'), 'symbol' => '$', 'decimals' => 2],
            ['code' => 'CRC', 'name' => __('statamic::dictionary-currencies.CRC'), 'symbol' => '₡', 'decimals' => 2],
            ['code' => 'CUP', 'name' => __('statamic::dictionary-currencies.CUP'), 'symbol' => '$', 'decimals' => 2],
            ...
            ['code' => 'FJD', 'name' => __('statamic::dictionary-currencies.FJD'), 'symbol' => '$', 'decimals' => 2],
            ['code' => 'FKP', 'name' => __('statamic::dictionary-currencies.FKP'), 'symbol' => '£', 'decimals' => 2],
            ...
            ['code' => 'GIP', 'name' => __('statamic::dictionary-currencies.GIP'), 'symbol' => '£', 'decimals' => 2],
            ['code' => 'GMD', 'name' => __('statamic::dictionary-currencies.GMD'), 'symbol' => 'D', 'decimals' => 2],
            ...
            ['code' => 'GYD', 'name' => __('statamic::dictionary-currencies.GYD'), 'symbol' => '$', 'decimals' => 2],
            ...
            ['code' => 'HTG', 'name' => __('statamic::dictionary-currencies.HTG'), 'symbol' => 'G', 'decimals' => 2],
            ['code' => 'HUF', 'name' => __('statamic::dictionary-currencies.HUF'), 'symbol' => 'Ft', 'decimals' => 2],
            ['code' => 'IDR', 'name' => __('statamic::dictionary-currencies.IDR'), 'symbol' => 'Rp', 'decimals' => 2],
            ...
            ['code' => 'IQD', 'name' => __('statamic::dictionary-currencies.IQD'), 'symbol' => 'د.ع.‏', 'decimals' => 3],
            ['code' => 'IRR', 'name' => __('statamic::dictionary-currencies.IRR'), 'symbol' => '﷼', 'decimals' => 2],
            ...
            ['code' => 'KGS', 'name' => __('statamic::dictionary-currencies.KGS'), 'symbol' => '⃀', 'decimals' => 2],
            ...
            ['code' => 'KPW', 'name' => __('statamic::dictionary-currencies.KPW'), 'symbol' => '₩', 'decimals' => 2],
            ...
            ['code' => 'KYD', 'name' => __('statamic::dictionary-currencies.KYD'), 'symbol' => '$', 'decimals' => 2],
            ['code' => 'KZT', 'name' => __('statamic::dictionary-currencies.KZT'), 'symbol' => 'тңг.', 'decimals' => 2],
            ['code' => 'LAK', 'name' => __('statamic::dictionary-currencies.LAK'), 'symbol' => '₭', 'decimals' => 2],
            ['code' => 'LBP', 'name' => __('statamic::dictionary-currencies.LBP'), 'symbol' => 'ل.ل.‏', 'decimals' => 2],
            ['code' => 'LKR', 'name' => __('statamic::dictionary-currencies.LKR'), 'symbol' => 'SL Re', 'decimals' => 2],
            ['code' => 'LRD', 'name' => __('statamic::dictionary-currencies.LRD'), 'symbol' => '$', 'decimals' => 2],
            ['code' => 'LSL', 'name' => __('statamic::dictionary-currencies.LSL'), 'symbol' => 'L', 'decimals' => 2],
            ...
            ['code' => 'MGA', 'name' => __('statamic::dictionary-currencies.MGA'), 'symbol' => 'MGA', 'decimals' => 2],
            ['code' => 'MKD', 'name' => __('statamic::dictionary-currencies.MKD'), 'symbol' => 'MKD', 'decimals' => 2],
            ['code' => 'MMK', 'name' => __('statamic::dictionary-currencies.MMK'), 'symbol' => 'K', 'decimals' => 2],
            ['code' => 'MNT', 'name' => __('statamic::dictionary-currencies.MNT'), 'symbol' => '₮', 'decimals' => 2],
            ['code' => 'MOP', 'name' => __('statamic::dictionary-currencies.MOP'), 'symbol' => 'MOP$', 'decimals' => 2],
            ['code' => 'MRU', 'name' => __('statamic::dictionary-currencies.MRU'), 'symbol' => 'UM', 'decimals' => 2],
            ['code' => 'MUR', 'name' => __('statamic::dictionary-currencies.MUR'), 'symbol' => 'MURs', 'decimals' => 2],
            ['code' => 'MVR', 'name' => __('statamic::dictionary-currencies.MVR'), 'symbol' => 'Rf', 'decimals' => 2],
            ['code' => 'MWK', 'name' => __('statamic::dictionary-currencies.MWK'), 'symbol' => 'K', 'decimals' => 2],
            ...
            ['code' => 'PGK', 'name' => __('statamic::dictionary-currencies.PGK'), 'symbol' => 'K', 'decimals' => 2],
            ['code' => 'PHP', 'name' => __('statamic::dictionary-currencies.PHP'), 'symbol' => '₱', 'decimals' => 2],
            ['code' => 'PKR', 'name' => __('statamic::dictionary-currencies.PKR'), 'symbol' => '₨', 'decimals' => 2],
            ...
            ['code' => 'RSD', 'name' => __('statamic::dictionary-currencies.RSD'), 'symbol' => 'дин.', 'decimals' => 2],
            ...
            ['code' => 'SBD', 'name' => __('statamic::dictionary-currencies.SBD'), 'symbol' => '$', 'decimals' => 2],
            ['code' => 'SCR', 'name' => __('statamic::dictionary-currencies.SCR'), 'symbol' => 'Re', 'decimals' => 2],
            ...
            ['code' => 'SHP', 'name' => __('statamic::dictionary-currencies.SHP'), 'symbol' => '£', 'decimals' => 2],
            ['code' => 'SLE', 'name' => __('statamic::dictionary-currencies.SLE'), 'symbol' => 'Le', 'decimals' => 2],
            ['code' => 'SOS', 'name' => __('statamic::dictionary-currencies.SOS'), 'symbol' => 'Ssh', 'decimals' => 2],
            ['code' => 'SRD', 'name' => __('statamic::dictionary-currencies.SRD'), 'symbol' => '$', 'decimals' => 2],
            ['code' => 'SSP', 'name' => __('statamic::dictionary-currencies.SSP'), 'symbol' => 'SS£', 'decimals' => 2],
            ['code' => 'STN', 'name' => __('statamic::dictionary-currencies.STN'), 'symbol' => 'Db', 'decimals' => 2],
            ['code' => 'SYP', 'name' => __('statamic::dictionary-currencies.SYP'), 'symbol' => 'ل.س.‏', 'decimals' => 2],
            ['code' => 'SZL', 'name' => __('statamic::dictionary-currencies.SZL'), 'symbol' => 'L', 'decimals' => 2],
            ['code' => 'THB', 'name' => __('statamic::dictionary-currencies.THB'), 'symbol' => '฿', 'decimals' => 2],
            ['code' => 'TJS', 'name' => __('statamic::dictionary-currencies.TJS'), 'symbol' => 'SM', 'decimals' => 2],
            ['code' => 'TMT', 'name' => __('statamic::dictionary-currencies.TMT'), 'symbol' => 'm', 'decimals' => 2],
            ...
            ['code' => 'TZS', 'name' => __('statamic::dictionary-currencies.TZS'), 'symbol' => 'TSh', 'decimals' => 2],
            ...
            ['code' => 'UZS', 'name' => __('statamic::dictionary-currencies.UZS'), 'symbol' => 'UZS', 'decimals' => 2],
            ['code' => 'VED', 'name' => __('statamic::dictionary-currencies.VED'), 'symbol' => 'Bs.D', 'decimals' => 2],
            ['code' => 'VES', 'name' => __('statamic::dictionary-currencies.VES'), 'symbol' => 'Bs.S.', 'decimals' => 2],
            ['code' => 'VND', 'name' => __('statamic::dictionary-currencies.VND'), 'symbol' => '₫', 'decimals' => 0],
            ['code' => 'VUV', 'name' => __('statamic::dictionary-currencies.VUV'), 'symbol' => 'VT', 'decimals' => 0],
            ['code' => 'WST', 'name' => __('statamic::dictionary-currencies.WST'), 'symbol' => '$', 'decimals' => 2],
            ['code' => 'XAF', 'name' => __('statamic::dictionary-currencies.XAF'), 'symbol' => 'FCFA', 'decimals' => 0],
            ['code' => 'XCD', 'name' => __('statamic::dictionary-currencies.XCD'), 'symbol' => 'EC$', 'decimals' => 2],
            ['code' => 'XCG', 'name' => __('statamic::dictionary-currencies.XCG'), 'symbol' => 'Cg', 'decimals' => 2],
            ['code' => 'XOF', 'name' => __('statamic::dictionary-currencies.XOF'), 'symbol' => 'CFA', 'decimals' => 0],
            ['code' => 'XPF', 'name' => __('statamic::dictionary-currencies.XPF'), 'symbol' => '₣', 'decimals' => 0],
            ['code' => 'YER', 'name' => __('statamic::dictionary-currencies.YER'), 'symbol' => 'ر.ي.‏', 'decimals' => 2],
