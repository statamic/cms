...
class RendersAttributesTest extends TestCase
{
    ...
    public function it_renders_attributes_from_array()
    {
        ...
        $this->assertEquals('class="m-0 mb-2___REPLACED" :name="first_name" disabled="true" autocomplete="true" focusable="false"', $output);
    }
    ...
    public function it_renders_attributes_from_params()
    {
        ...
        $this->assertEquals('class="m-0 mb-2___REPLACED" name="Han" src="avatar.jpg" focusable="false" disabled="true" autocomplete="true"', $output);
    }
    ...
    public function it_wont_render_attributes_for_known_params_unless_attr_prepended()
    {
        ...
        $this->assertEquals('class="m-0 mb-2___REPLACED"', $output);
        ...
        $this->assertEquals('class="m-0 mb-2___REPLACED" src="avatar.jpg"', $output);
    }
    ...
    public function it_will_render_falsy_attributes()
    {
        ...
        $this->assertEquals('class="m-0 mb-2___REPLACED" name="Han" src="avatar.jpg" focusable="false" disabled="true" autocomplete="true" aria-hidden="true"', $output);
    }
}
