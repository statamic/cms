...
class NavTest extends TestCase
{
    ...
    {
        File::put($svg = statamic_path('resources/svg/icons/regular/test.svg'), 'the totally real svg');
    ...
    {
        File::put($svg = statamic_path('resources/svg/icons/regular/droid.svg'), '<svg>droid</svg>');
