...
class NavTest extends TestCase
{
    ...
    {
        File::put($svg = statamic_path('resources/svg/icons/default/test.svg'), 'the totally real svg');
    ...
    {
        File::put($svg = statamic_path('resources/svg/icons/default/droid.svg'), '<svg>droid</svg>');
