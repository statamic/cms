...
class ComposerTest extends TestCase
{
    ...
    public function it_can_require_update_downgrade_and_remove_a_package()
    {
        ...
        $this->assertTrue(Arr::contains(Cache::get('composer.test/package')['output'], 'Installing test/package'));
        ...
        $this->assertTrue(Arr::contains(Cache::get('composer.test/package')['output'], 'Updating test/package'));
        ...
        $this->assertFileExists($this->basePath('vendor/test/package'));
        $this->assertEquals('1.0.0', $installed->get('test/package')->version);
        $this->assertTrue(Arr::contains(Cache::get('composer.test/package')['output'], 'Downgrading test/package'));
        ...
        $this->assertFileNotExists($this->basePath('vendor/test/package'));
        $this->assertTrue(Arr::contains(Cache::get('composer.test/package')['output'], 'Removing test/package'));
    }
