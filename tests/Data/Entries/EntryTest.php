...
class EntryTest extends TestCase
{
    ...
    /** @test */
    public function it_gets_the_auto_generated_title()
    {
        $collection = tap(Collection::make('products')->titleFormats('{{ product }} by {{ company }}'))->save();
    ...
    /** @test */
    public function it_gets_the_auto_generated_title_with_mustache_tags()
    {
        $collection = tap(Collection::make('products')->titleFormats('{product} by {company}'))->save();
