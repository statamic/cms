...
class EditAddonSettingsTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $addonA = $this->makeFromPackage(['slug' => 'test-addon']);
        $addonB = $this->makeFromPackage(['slug' => 'second-test-addon', 'id' => 'vendor/second-test-addon']);

        Facades\Addon::shouldReceive('all')->andReturn(collect([$addonA, $addonB]));
        Facades\Addon::shouldReceive('get')->with('vendor/test-addon')->andReturn($addonA);
        Facades\Addon::shouldReceive('get')->with('vendor/second-test-addon')->andReturn($addonB);
