...
class SlugFieldtypeScaffoldingTest extends ScaffoldingTestCase
{
    ...
    #[Test]
    public function it_scaffolds_slug_fieldtype_antlers()
    {
    ...
    #[Test]
    public function it_scaffolds_nested_fieldtype_antlers()
    {
    ...
    #[Test]
    public function it_scaffolds_slug_fieldtype_blade()
    {
    ...
    #[Test]
    public function it_scaffolds_nested_slug_fieldtype_blade()
    {
