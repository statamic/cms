...
class TextFieldtypeScaffoldingTest extends ScaffoldingTestCase
{
    ...
    #[Test]
    public function it_scaffolds_text_fieldtype_antlers()
    {
    ...
    #[Test]
    public function it_scaffolds_nested_text_fieldtype_antlers()
    {
    ...
    #[Test]
    public function it_scaffolds_text_fieldtype_blade()
    {
    ...
    #[Test]
    public function it_scaffolds_nested_text_fieldtype_blade()
    {
