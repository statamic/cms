...
class IntegerFieldtypeScaffoldingTest extends ScaffoldingTestCase
{
    ...
    #[Test]
    public function it_scaffolds_integer_fieldtype_antlers()
    {
    ...
    #[Test]
    public function it_scaffolds_nested_integer_fieldtype_antlers()
    {
    ...
    #[Test]
    public function it_scaffolds_integer_fieldtype_blade()
    {
    ...
    #[Test]
    public function it_scaffolds_nested_integer_fieldtype_blade()
    {
