...
{{ params_tag class="absolute right-0 top-0 w-2/3 md:w-1/3 h-auto opacity-70"
    ...
    <div class="md:absolute md:z-10 p-16___REPLACED md:p-8 md:bottom-0 md:right-0 w-full md:w-4/5 bg-white/90 md:translate-y-1/3 backdrop-blur-xl backdrop-saturate-150 firefox:bg-white">
...
EOT;
        ...
        $checkString = '<div class="md:absolute md:z-10 p-16___REPLACED md:p-8 md:bottom-0 md:right-0 w-full md:w-4/5 bg-white/90 md:translate-y-1/3 backdrop-blur-xl backdrop-saturate-150 firefox:bg-white">';
