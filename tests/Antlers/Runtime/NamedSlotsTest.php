...
<div class="max-w-sm rounded overflow-hidden shadow-lg">
    ...
    <div class="px-6 pt-4 pb-2">
        ...
        <span class="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-4___REPLACED mb-4___REPLACED">#tag1</span>
        <span class="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-4___REPLACED mb-4___REPLACED">#tag2</span>
        <span class="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-4___REPLACED mb-4___REPLACED">#tag3</span>
