export default class Toasts {
    ...
    success(message, opts) {
        this.toasted.success(message, this.#normalizeToastOptions({
            iconPack: 'callback',
            icon: (el) => {
    ...
    info(message, opts) {
        this.toasted.show(message, this.#normalizeToastOptions({
            iconPack: 'callback',
            icon: (el) => {
    ...
    error(message, opts) {
        this.toasted.error(message, this.#normalizeToastOptions({
            iconPack: 'callback',
            icon: (el) => {
