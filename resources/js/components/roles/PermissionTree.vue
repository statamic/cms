<template>
    ...
    <div>
        <div v-for="permission in permissions" :key="permission.value">
            <label
                class="flex items-center justify-between py-2 pe-4 border-b dark:border-dark-900 group hover:bg-gray-100 dark:hover:bg-dark-700"
                :style="{paddingInlineStart: `${16*depth}px`}"
            >
                <div class="flex">
