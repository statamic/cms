    ...
    <div>
        ...
        <header class="mb-6" v-if="mounted">
            ...
            <div class="flex items-center">
                ...
                <dropdown-list v-if="editable" class="me-2">
                    <slot name="twirldown" />
                </dropdown-list>

                <a @click="$refs.tree.cancel" class="text-2xs text-blue me-4 underline" v-if="isDirty" v-text="__('Discard changes')" />
                ...
                <dropdown-list v-if="canEdit" :disabled="! hasCollections">
                    <template #trigger>
                        <button
                            class="btn"
                            :class="{ 'flex items-center pe-4': hasCollections }"
                            @click="addLink"
                        >
                            {{ __('Add Nav Item') }}
                            <svg-icon name="micro/chevron-down-xs" class="w-2 ms-4" v-if="hasCollections" />
                        </button>
                    </template>
                ...
                <div class="card p-4 content w-full">
                    <div class="flex flex-wrap w-full">
                        <a :href="editUrl" class="w-full lg:w-1/2 p-4 flex items-start hover:bg-gray-200 dark:hover:bg-dark-550 rounded-md group">
                            <svg-icon name="light/hammer-wrench" class="h-8 w-8 me-4 text-gray-800 dark:text-dark-175" />
                            <div class="flex-1 mb-4 md:mb-0 md:me-6">
                        ...
                        <a @click="linkPage()" class="w-full lg:w-1/2 p-4 flex items-start hover:bg-gray-200 dark:hover:bg-dark-550 rounded-md group">
                            <svg-icon name="paperclip" class="h-8 w-8 me-4 text-gray-800 dark:text-dark-175" />
                            <div class="flex-1 mb-4 md:mb-0 md:me-6">
                        ...
                        <a @click="linkEntries()" v-if="hasCollections" class="w-full lg:w-1/2 p-4 flex items-start hover:bg-gray-200 dark:hover:bg-dark-550 rounded-md group">
                            <svg-icon name="light/hierarchy-files" class="h-8 w-8 me-4 text-gray-800 dark:text-dark-175" />
                            <div class="flex-1 mb-4 md:mb-0 md:me-6">
                        ...
                        <a :href="docs_url('navigation')" class="w-full lg:w-1/2 p-4 flex items-start hover:bg-gray-200 dark:hover:bg-dark-550 rounded-md group">
                            <svg-icon name="light/book-pages" class="h-8 w-8 me-4 text-gray-800 dark:text-dark-175" />
                            <div class="flex-1 mb-4 md:mb-0 md:me-6">
