<template>
    <div class=" flex items-center">
            ...
            <popover name="swatches" class="color-picker" placement="bottom-start">
                ...
                <template #default="{ close: closePopover }">
                    <div class="p-4">
                        ...
                        >
                            <input
                                class="h-10 w-full cursor-pointer input-text w-full rounded p-[2px] me-2"
                                type="color"
                                :value="customColor"
        ...
        <button v-if="value" class="btn-close ms-1" :aria-label="__('Reset')" @click="resetColor">&times;</button>
    </div>
</template>
