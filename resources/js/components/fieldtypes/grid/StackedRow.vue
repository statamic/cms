<template>
    ...
    >
        ...
        <div class="replicator-set-header">
            ...
            <div class="py-2 ps-2 replicator-set-header-inner flex justify-end items-end w-full">
                <button v-if="canAddRows" class="flex self-end group items-center me-2" @click="$emit('duplicate', index)" :aria-label="__('Duplicate Row')">
