<template>
    <div :class="sortableItemClass">
        ...
        <div class="replicator-set" :class="{ 'has-error': this.hasError }" :data-type="config.handle">
            ...
            >
                <div v-if="!isReadOnly" class="item-move sortable-handle" :class="sortableHandleClass"></div>

                <div
                    class="flex items-center flex-1 p-2 replicator-set-header-inner cursor-pointer"
                ...
                >
                    ...
                    <div v-if="config.instructions && !collapsed" class="flex items-center">
                        <svg-icon
                            name="micro/circle-help"
                            class="text-gray-700 hover:text-gray-800 h-3 w-3 text-xs"
                            v-tooltip="{ content: $filters.markdown(__(config.instructions)), html:true }"
                        />
                    </div>
                ...
                <div v-if="!isReadOnly" class="replicator-set-controls">
                    <toggle-fieldtype
                        handle="set-enabled"
            ...
            <div v-show="!collapsed" class="replicator-set-body publish-fields @container">
                <set-field
