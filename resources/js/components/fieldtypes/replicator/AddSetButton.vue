<template>
    <div class="inline-block" v-if="variant === 'button'">
        <set-picker :enabled="enabled" :sets="groups" align="start" :loading-set="loadingSet" :search-placeholder="searchPlaceholder" @added="addSet">
            <template #trigger>
    ...
    <set-picker v-else :enabled="enabled" :sets="groups" align="center" :loading-set="loadingSet" :search-placeholder="searchPlaceholder" @added="addSet">
        <template #trigger>
            <div
