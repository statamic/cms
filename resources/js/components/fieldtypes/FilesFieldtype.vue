        ...
        >
            <div slot-scope="{ dragging }" class="assets-fieldtype-drag-container">
                ...
                <div class="drag-notification" v-show="dragging">
                    <svg-icon name="upload" class="h-8 w-8 me-6" />
                    <span>{{ __('Drop File to Upload') }}</span>
                </div>

                <div class="assets-fieldtype-picker py-4" :class="{ 'is-expanded': value.length }">
                    <p class="asset-upload-control text-xs text-gray-600 ms-0">
                        ...
                        <tbody>
                            ...
                            >
                                <td class="flex items-center">
                                    ...
                                    <div
                                        class="flex items-center flex-1 ms-2 text-xs text-start truncate"
                                        v-text="file.slice(11)"
                                    />
                                </td>
                                <td class="p-0 w-8 text-end align-middle">
                                    <button
                                        @click="remove(i)"
