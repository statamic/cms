<template>
    <div class="datetime min-w-[145px]">
        ...
        <button type="button" class="btn flex mb-2 md:mb-0 items-center ps-3" v-if="!isReadOnly && config.inline === false && !hasDate" @click="addDate" tabindex="0">
            <svg-icon name="light/calendar" class="w-4 h-4 me-2"></svg-icon>
    		{{ __('Add Date') }}
    	</button>
