                        ...
                        <tr>
                            ...
                            <th v-for="(column, index) in columnCount" :key="index">
                                <div class="flex h-6 items-center justify-between">
                                    ...
                                    <ui-button icon="x" variant="subtle" size="xs" delete-action round @click="confirmDeleteColumn(index)" :aria-label="__('Delete Column')" v-tooltip="__('Delete Column')" class="-me-1" />
                                </div>
                            </th>
                        ...
                        <tbody>
                            <tr class="sortable-row" v-for="(row, rowIndex) in data" :key="row._id">
                                ...
                                <td class="row-controls" v-if="canDeleteRows">
                                    <ui-button icon="x" variant="subtle" delete-action size="xs" round @click="confirmDeleteRow(rowIndex)" :aria-label="__('Delete Row')" v-tooltip="__('Delete Row')" />
                                </td>
                            </tr>
                        </tbody>
                    </sortable-list>
