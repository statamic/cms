                    ...
                    <div>
                        ...
                        <div :class="`mode-wrap mode-${mode}`, { 'prose p-3': mode == 'preview' }" @click="focus">
                            ...
                            >
                                ...
                                <footer class="flex items-center justify-between bg-gray-50 dark:bg-gray-900 rounded-b-[calc(var(--radius-lg)-1px)] border-t border-gray-200 dark:border-white/10 p-1 text-sm w-full" :class="{ 'absolute inset-x-0 bottom-0 rounded-': fullScreenMode }">
