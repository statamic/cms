                    ...
                    <div>
                        ...
                        <div :class="`mode-wrap mode-${mode}`, { 'prose p-3': mode == 'preview' }" @click="focus">
                            <div
                                ...
                                @keydown="shortcut"
                            >
                                <div class="editor relative top-[0.5px] z-(--z-index-above) st-text-legibility" ref="codemirror" :dir="contentDirection" :class="{ 'focus-within:focus-outline': !fullScreenMode }">
                                    <div
