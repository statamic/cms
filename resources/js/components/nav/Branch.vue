        ...
        <div class="flex items-center flex-1 p-2 ms-2 text-xs leading-normal">
            <div class="flex items-center flex-1" :class="{ 'opacity-50': isHidden || isInHiddenSection }">
                <template v-if="! isSection">
                    <i v-if="isAlreadySvg" class="w-4 h-4 me-2" v-html="icon"></i>
                    <svg-icon v-else class="w-4 h-4 me-2" :name="icon" />
                </template>
                ...
                <div v-if="item.collection" class="ms-4 flex items-center">
