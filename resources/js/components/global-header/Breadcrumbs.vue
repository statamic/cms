...
<template>
    <div class="items-center hidden md:flex gap-1 2xl:gap-2" data-global-header-breadcrumbs>
        <div
            v-for="(breadcrumb, breadcrumbIndex) in breadcrumbs"
            :key="breadcrumbIndex"
            class="items-center gap-1 2xl:gap-2 md:flex relative"
        >
            ...
            <Component
                ...
                class="
                    ...
                    text-[0.8125rem] leading-tight gap-1 rounded-lg
