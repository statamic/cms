...
<template>
    <div class="items-center hidden md:flex gap-1.5 2xl:gap-2" data-global-header-breadcrumbs>
        <div
            v-for="(breadcrumb, breadcrumbIndex) in breadcrumbs"
            :key="breadcrumbIndex"
            class="items-center gap-1.5 2xl:gap-2 md:flex relative"
        >
            ...
            <Component
                ...
                class="
                    ...
                    bg-transparent hover:bg-gray-400/10 text-gray-900 dark:text-gray-300 dark:hover:bg-white/7 dark:hover:text-gray-200 h-8
                    text-[0.8125rem] leading-tight gap-1.5 2xl:gap-2 rounded-lg
                    dark:text-white/85! hover:text-white! px-1 2xl:px-2 mr-1.75
                "
                :href="breadcrumb.url"
