...
<template>
    <header class="h-14 bg-global-header-bg flex gap-8 justify-between space-x-2 items-center text-white px-2 lg:px-4 fixed overflow-x-auto top-0 inset-x-0 z-(--z-index-above)">
