...
<template>
    <template v-if="customLogo">
        <div class="flex items-center gap-3 relative rounded-xs">
            <button data-toggle-nav-button class="flex items-center group rounded-xs cursor-pointer" type="button" @click="toggleNav" :aria-label="__('Toggle Nav')" style="--focus-outline-offset: 0.2rem;">
