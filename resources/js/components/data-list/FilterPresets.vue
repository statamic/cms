<template>
    <div class="pt-2 pe-2">
        <div class="flex flex-wrap items-center">
            ...
            <button class="pill-tab me-1" :class="{ 'active': ! activePreset }" @click="viewAll" v-text="__('All')" />

            <template v-for="(preset, handle) in presets">
                <button class="pill-tab active me-1" v-if="handle === activePreset">
                    {{ preset.display }}
                    <dropdown-list class="ms-2" placement="bottom-start">
                ...
                <button class="pill-tab me-1" v-else @click="viewPreset(handle)">
                    {{ preset.display }}
                </button>
            </template>
