    ...
    <div>
        <div v-if="hasAvailableFieldFilters">
            ...
            <div class="flex border-t dark:border-dark-900 text-gray-800 dark:text-dark-150">
                <button
                    class="p-2 hover:bg-gray-100 dark:hover:bg-dark-600 rounded-es text-xs flex-1"
                    v-text="__('Clear')"
                    @click="resetAll"
                />
                <button
                    class="p-2 hover:bg-gray-100 dark:hover:bg-dark-600 flex-1 rounded-ee border-s dark:border-dark-900 text-xs"
                    v-text="__('Close')"
                    @click="$emit('closed')"
                />
            </div>
