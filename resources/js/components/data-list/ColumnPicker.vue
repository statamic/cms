    ...
    <div>
        ...
        <modal v-if="open" name="column-picker" @closed="open = false" draggable=".modal-drag-handle" click-to-close>
            <div class="flex flex-col h-full -max-h-screen-px">
                ...
                <header class="modal-drag-handle p-4 bg-gray-200 dark:bg-dark-500 border-b dark:border-dark-900 flex items-center justify-between cursor-grab active:cursor-grabbing">
                    <h2>{{ __('Customize Columns') }}</h2>
                    <button class="btn-close" @click="open = false" :aria-label="__('Close Editor')">&times;</button>
                </header>

                <div class="flex grow min-h-0 rounded-t-md bg-gray-100 dark:bg-dark-550">
                    <!-- Available Columns -->
                    <div class="outline-none rtl:text-right ltr:text-left w-1/2 rtl:border-l ltr:border-r dark:border-dark-900 flex flex-col">
                        <header v-text="__('Available Columns')" class="border-b dark:border-dark-900 py-2 px-3 text-sm bg-white dark:bg-dark-575 font-medium"/>
                    ...
                    <div class="w-1/2 flex flex-col">
                        <header v-text="__('Displayed Columns')" class="border-b dark:border-dark-900 px-3 py-2 text-sm bg-white dark:bg-dark-575 rtl:rounded-tr-md ltr:rounded-tl-md font-medium flex-none"/>
                ...
                <footer class="px-3 py-2 border-t dark:border-dark-900 flex items-center justify-end" v-if="preferencesKey">
