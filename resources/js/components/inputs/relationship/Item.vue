<template>
    ...
    >
        ...
        <div class="item-inner">
            <div v-if="statusIcon" class="little-dot me-2 hidden @sm:block" :class="item.status" />
            ...
            <div class="flex items-center flex-1 justify-end">
                <div v-if="item.hint" v-text="item.hint" class="text-4xs text-gray-600 uppercase whitespace-nowrap me-2 hidden @sm:block" />
