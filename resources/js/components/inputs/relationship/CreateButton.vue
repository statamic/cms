<template>
    ...
    <div>
        <dropdown-list :disabled="creatables.length === 1">
            <template #trigger>
                <button
                    class="text-button text-blue dark:text-dark-blue-100 hover:text-gray-800 dark:hover:text-dark-100 me-6 flex items-center outline-none"
                    @click="create"
                >
                    <svg-icon name="light/content-writing" class="me-1 h-4 w-4 flex items-center"></svg-icon>
