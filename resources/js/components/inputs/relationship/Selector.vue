            ...
            <div slot-scope="{}" class="flex flex-col h-full">
                <div class="bg-white dark:bg-dark-800 z-1">
                    <div class="py-2 px-4 flex items-center justify-between">
                        ...
                        <div class="btn-group ms-4" v-if="canUseTree">
                            ...
                            >
                                <template slot="cell-title" slot-scope="{ row: entry }">
                                    <div class="flex items-center">
                                        <div class="little-dot me-2" v-tooltip="getStatusLabel(entry)" :class="getStatusClass(entry)" v-if="entry.status && ! columnShowing('status')" />
                                        {{ entry.title }}
                                    </div>
                                </template>
