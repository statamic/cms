    ...
    <div class="flex">
        ...
        <div class="flex items-center flex-1 p-2 rtl:mr-2 ltr:ml-2 text-xs leading-normal">
            ...
            <div class="rtl:pl-2 ltr:pr-2 flex items-center">
                <div v-if="showBlueprint && page.entry_blueprint" v-text="__(page.entry_blueprint.title)" class="shrink text-4xs text-gray-600 dark:text-dark-175 uppercase rtl:mr-4 ltr:ml-4" />
