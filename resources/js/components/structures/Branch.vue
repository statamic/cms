<template>
    ...
    <div class="flex">
        ...
        <div class="flex items-center flex-1 p-2 ms-2 text-xs leading-normal">
            <div class="flex items-center grow" @click="$emit('branch-clicked', page)">
                <div class="little-dot me-2" :class="getStatusClass()" v-tooltip="getStatusTooltip()" />
                <svg-icon name="home-page" class="me-2 h-4 w-4 text-gray-800 dark:text-dark-150" v-if="isRoot" v-tooltip="__('This is the root page')" />
                <a
                ...
                <span v-if="showSlugs" class="ms-2 font-mono text-gray-700 dark:text-dark-175 text-2xs pt-px">
                    {{ isRoot ? '/' : page.slug }}
                </span>
                ...
                <div v-if="page.collection && editable" class="ms-4 flex items-center">
            ...
            <div class="pe-2 flex items-center">
                <div v-if="showBlueprint && page.entry_blueprint" v-text="__(page.entry_blueprint.title)" class="shrink text-4xs text-gray-600 dark:text-dark-175 uppercase ms-4" />

                <slot name="branch-icon" :branch="page" />

                <dropdown-list class="ms-4" :class="{'invisible': isRoot, 'hidden': !editable}">
