                        ...
                        >
                            ...
                            <template slot="cell-roles" slot-scope="{ row: user, value: roles }">
                                <div class="role-index-field">
                                    ...
                                    <div v-for="(role, i) in (roles || [])" class="role-index-field-item rtl:ml-1 ltr:mr-1 mb-1.5">{{ role.title }}</div>
                                </div>
                            </template>
                            <template slot="cell-groups" slot-scope="{ row: user, value: groups }">
                                <div class="groups-index-field">
                                    <div v-for="group in (groups || [])" class="groups-index-field-item rtl:ml-1 ltr:mr-1 mb-1.5">{{ group.title }}</div>
                                </div>
                            </template>
