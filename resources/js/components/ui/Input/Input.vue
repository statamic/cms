...
const inputClasses = computed(() => {
    const classes = cva({
        base: [
            ...
            'border border-gray-300 contrast-more:border-gray-500 dark:border-x-0 dark:border-t-0 dark:border-white/7.5 dark:inset-shadow-2xs dark:inset-shadow-black',
