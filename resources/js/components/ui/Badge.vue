    ...
    const classes = cva({
        ...
        variants: {
            ...
            color: {
                ...
                sky: 'bg-sky-100/80 dark:bg-sky-300/30 border-sky-300 dark:border-sky-300/25 text-sky-700 dark:text-sky-50 [a]:hover:bg-sky-200/60 dark:[a]:hover:bg-sky-100/60 [button]:hover:bg-sky-200/60 dark:[button]:hover:bg-sky-50/60',
