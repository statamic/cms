    ...
    const classes = cva({
        ...
        variants: {
            ...
            color: {
                ...
                lime: 'bg-lime-50 dark:bg-gray-900 border-lime-400 dark:border-lime-700 text-lime-700 dark:text-lime-300 [a]:hover:bg-lime-100 dark:[a]:hover:bg-lime-900 [button]:hover:bg-lime-100 dark:[button]:hover:bg-gray-800',
                orange: 'bg-orange-50 dark:bg-gray-900 border-orange-400 dark:border-orange-700 text-orange-700 dark:text-orange-300 [a]:hover:bg-orange-100 [button]:hover:bg-orange-100 dark:[a]:hover:bg-orange-900 dark:[button]:hover:bg-gray-800',
                ...
                teal: 'bg-teal-50 dark:bg-gray-900 border-teal-400 dark:border-teal-700 text-teal-700 dark:text-teal-300 [a]:hover:bg-teal-100 dark:[a]:hover:bg-teal-900 [button]:hover:bg-teal-100 dark:[button]:hover:bg-teal-900',
                ...
                yellow: 'bg-yellow-50 dark:bg-gray-900 border-yellow-400 dark:border-yellow-700 text-yellow-700 dark:text-yellow-300 [a]:hover:bg-yellow-100 dark:[a]:hover:bg-yellow-900 [button]:hover:bg-yellow-100 dark:[button]:hover:bg-yellow-900',
            },
