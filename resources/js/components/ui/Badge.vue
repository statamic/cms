...
const badgeClasses = computed(() => {
    const classes = cva({
        ...
        variants: {
            ...
            color: {
                amber: 'bg-amber-50 dark:bg-gray-800 border-amber-400 dark:border-amber-700 text-amber-700 dark:text-amber-300 [a]:hover:bg-amber-100 [button]:hover:bg-amber-200 dark:[button]:hover:bg-gray-700',
                black: 'bg-gray-900 dark:bg-black border-black dark:border-gray-700 text-white dark:text-gray-300 [a]:hover:bg-gray-800 [button]:hover:bg-gray-800 dark:[button]:hover:bg-gray-800',
                blue: 'bg-blue-50 dark:bg-gray-800 border-blue-300 dark:border-blue-700 text-blue-700 dark:text-blue-300 [a]:hover:bg-blue-100 [button]:hover:bg-blue-100 dark:[button]:hover:bg-gray-700',
                cyan: 'bg-cyan-50 dark:bg-gray-800 border-cyan-400 dark:border-cyan-700 text-cyan-700 dark:text-cyan-300 [a]:hover:bg-cyan-100 [button]:hover:bg-cyan-100 dark:[button]:hover:bg-gray-700',
                ...
                emerald: 'bg-emerald-50 border-emerald-400 dark:border-emerald-700 text-emerald-700 dark:bg-gray-800 dark:text-emerald-300 [a]:hover:bg-emerald-100 [button]:hover:bg-emerald-100 dark:[button]:hover:bg-gray-700',
                ...
                orange: 'bg-orange-50 dark:bg-gray-800 border-orange-400 dark:border-orange-700 text-orange-700 dark:text-orange-300 [a]:hover:bg-orange-100 [button]:hover:bg-orange-100 dark:[a]:hover:bg-gray-700 dark:[button]:hover:bg-gray-700',
                ...
                violet: 'bg-violet-50 dark:bg-gray-800 border-violet-300 dark:border-violet-700 text-violet-700 dark:text-violet-300 [a]:hover:bg-violet-100 [button]:hover:bg-violet-100 dark:[a]:hover:bg-gray-700 dark:[button]:hover:bg-gray-700',
                white: 'bg-white border-gray-300 dark:border-gray-700 text-gray-700 dark:bg-gray-800 dark:text-gray-300 [a]:hover:bg-gray-100 [button]:hover:bg-gray-100 dark:[a]:hover:bg-gray-800 dark:[button]:hover:bg-gray-800',
