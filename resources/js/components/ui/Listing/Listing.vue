...
<template>
    <div>
        ...
        <slot v-if="!initializing" :items="items" :is-column-visible="isColumnVisible" :loading="loading">
            ...
            <div v-if="allowSearch || hasFilters || allowCustomizingColumns || $slots['toolbar-actions']" class="flex flex-wrap items-center gap-2 sm:gap-3 min-h-16 starting-style-transition">
