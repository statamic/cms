            ...
            <div class="border rounded-lg dark:border-gray-900">
                <div class="flex">
                    ...
                    <div class="flex w-1/2 flex-col text-start">
                        ...
                        <div class="flex flex-1 flex-col space-y-1 overflow-y-auto px-3 py-2 select-none bg-gray-100 dark:bg-gray-900 rounded-bs-lg">
                            <ui-checkbox-item
                    ...
                    <div class="flex w-1/2 flex-col text-start border-l dark:border-gray-700">
                        ...
                        <div class="overflow-y-auto bg-gray-100 dark:bg-gray-900 rounded-be-lg">
                            <sortable-list
