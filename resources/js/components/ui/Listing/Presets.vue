...
<template>
    <div
        class="relative flex shrink-0 space-x-2.5 px-2 -mt-2 sm:px-0 border-b border-gray-200 text-sm text-gray-500 dark:border-gray-800 dark:text-gray-500 starting-style-transition"
    >
