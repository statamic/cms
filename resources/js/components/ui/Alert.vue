...
const alertClasses = computed(() => {
    return cva({
        base: [
            ...
            '[&_[data-ui-description]]:text-inherit!',
            '[&_code]:px-0.75 [&_code]:mx-0.5 [&_code]:py-0.5 [&_code]:rounded-sm [&_code]:text-xs [&_code]:text-inherit!',
        ].join(' '),
        variants: {
            variant: {
                default: [
                ...
                error: [
                    ...
                    '[&_code]:bg-red-200/50! dark:[&_code]:bg-red-300/8!',
                ...
                success: [
                    ...
                    '[&_code]:bg-emerald-200/50! dark:[&_code]:bg-emerald-300/8!',
