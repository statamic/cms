...
const triggerClasses = cva({
    ...
    variants: {
        ...
        buttonAppearance: {
            true: 'border border-gray-300 with-contrast:border-gray-500 dark:border-b-0 dark:ring-3 dark:ring-gray-900 dark:border-white/10 shadow-ui-sm dark:shadow-md focus-within:focus-outline-within',
            false: '',
        },
        // disabled: {
