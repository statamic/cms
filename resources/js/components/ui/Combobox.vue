...
const triggerClasses = cva({
    ...
    variants: {
        ...
        buttonAppearance: {
            true: 'border border-gray-300 [.contrast-increased_&]:border-gray-500 dark:border-b-0 dark:ring-3 dark:ring-gray-900 dark:border-white/15 shadow-ui-sm dark:shadow-md',
            false: '',
        },
        // disabled: {
