<template>
    <div>
        <div class="flex items-center mb-6">
            <h1 class="flex-1">
                <span v-text="name" />
                <span v-if="currentVersion" class="font-normal text-gray-700 ms-2">{{ currentVersion }}</span>
            </h1>
            <button v-if="!onLatestVersion" class="btn-primary ms-4" @click="modalOpen = true">{{ __('Update') }}</button>
