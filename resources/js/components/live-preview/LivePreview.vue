            ...
            <div class="live-preview fixed flex flex-col">
                ...
                <transition name="live-preview-header-slide">
                    <div v-show="headerVisible" class="live-preview-header">
                        <div class="text-base text-gray-700 dark:text-dark-150 font-medium me-4">{{ __('Live Preview') }}</div>
                        <div class="flex items-center">
                            ...
                            <select-input :options="deviceSelectOptions" v-model="previewDevice" v-show="!poppedOut" class="ms-4" />
                            <select-input :options="targetSelectOptions" v-model="target" class="ms-4" v-if="targets.length > 1" />
