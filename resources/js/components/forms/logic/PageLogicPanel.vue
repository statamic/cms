...
<template>
    <div class="space-y-6">
        ...
        <div v-if="canAddRule" class="mt-8 mb-6 pt-4 border-t border-dashed border-gray-300 dark:border-gray-700">
            <Button :text="__('Add Rule')" icon="plus" size="sm" @click="addRule" />
        </div>
    </div>
</template>
