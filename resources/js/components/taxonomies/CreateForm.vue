    ...
    <div class="max-w-lg mt-4___REPLACED mx-auto">
        ...
        <div class="rounded p-6___REPLACED lg:px-20___REPLACED lg:py-5 shadow bg-white">
            <header class="text-center mb-16___REPLACED">
                <h1 class="mb-6___REPLACED">{{ __('Create Taxonomy') }}</h1>
                <p class="text-grey" v-text="__('messages.taxonomy_configure_intro')" />
            </header>
            ...
            <div class="mb-4___REPLACED">
                ...
                <div class="text-2xs text-grey-60 mt-2___REPLACED flex items-center">
                    {{ __('messages.taxonomy_configure_handle_instructions') }}
                </div>
            </div>
        </div>
