<template>
    <CreateForm
        ...
        @submit="submit"
    >
        <ui-card-panel :heading="__('Taxonomy Details')">
            <div class="space-y-8">
                <ui-field :label="__('Title')" :instructions="__('messages.taxonomy_configure_title_instructions')" :instructions-below="true">
                    <ui-input v-model="title" autofocus tabindex="1" />
                </ui-field>
                <ui-field :label="__('Handle')" :instructions="__('messages.taxonomy_configure_handle_instructions')" :instructions-below="true">
