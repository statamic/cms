<template>
    <div class="h-full overflow-auto bg-white dark:bg-gray-800 focus-none p-3 pt-0">
        ...
        <header v-if="!loading" class="flex items-center justify-between pl-3 pt-3 pb-3 -mb-3 sticky top-0 z-1 bg-gradient-to-b from-white from-25% dark:from-gray-800">
            <Heading :text="__(values.display) || __(config.display) || config.handle" size="lg" :icon="fieldtype.icon" class="bg-gradient-to-b from-white dark:from-gray-800 pb-4 -mb-4 pr-2" />
