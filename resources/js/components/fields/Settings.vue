<template>
    <div class="h-full overflow-auto bg-white dark:bg-gray-800 focus-none p-3 pt-0 rounded-l-xl">
        <div v-if="loading" class="absolute inset-0 z-200 flex items-center justify-center text-center">
            <Icon name="loading" />
        </div>

        <header v-if="!loading" class="flex items-center justify-between pt-3 pb-4 pl-3 sticky top-0 z-1 mask-heading-left">
        ...
        <section v-if="!loading" class="isolate px-3 py-4 pt-0">
