        ...
        <div class="form-group publish-field select-fieldtype field-w-full">
            ...
            <div class="help-block -mt-2">
                <p>
                    ...
                    <span v-if="helpBlock" class="italic text-gray-500 float-end">
                        {{ __('Example') }}:
            ...
            >
                ...
                <template #option="{ value, display }">
                    {{ __(display) }} <code class="ms-2">{{ valueWithoutTrailingColon(value) }}</code>
                </template>
                <template #no-options="{ search }">
                    <div class="vs__dropdown-option text-start">{{ __('Add') }} <code class="ms-2">{{ search }}</code></div>
                </template>
            </v-select>
