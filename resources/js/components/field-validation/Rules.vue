        ...
        <div class="form-group publish-field select-fieldtype field-w-full">
            ...
            <div class="v-select">
                <sortable-list
                    ...
                    v-model="rules"
                >
                    <div class="flex flex-wrap outline-none vs__selected-options-outside">
                        <span v-for="rule in rules" :key="rule" class="mt-2 vs__selected sortable-item">
                            {{ rule }}
