...
<template>
    <div class="bg-gray-100 dark:bg-gray-900 rounded-2xl p-3 lg:p-6">
        <CalendarRoot
            v-model="currentDate"
            :locale="$date.locale"
            fixed-weeks
                    ...
                    <template v-for="month in grid" :key="month.value.toString()">
                        ...
                        >
                            <CalendarCell
                                ...
                                :date="weekDate"
                                class="aspect-square p-2 rounded-xl shadow-ui-sm"
                                :class="{
                                ...
                                >
                                    ...
                                    <div
                                        ...
                                        :class="{
                                            ...
                                            'bg-ui-accent text-white rounded-full size-6 flex items-center justify-center': today && !selected
                                        }"
                                    />
