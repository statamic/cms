        ...
        <ListingTable contained>
                ...
                <tr v-if="creatingFolder">
                    ...
                    <td :colspan="columns.length - 1">
                        <a class="group flex cursor-pointer items-center">
                            <file-icon
                                extension="folder"
                                class="me-2 inline-block size-8 text-ui-accent-bg group-hover:text-ui-accent-bg/80 dark:text-dark-ui-accent-bg dark:group-hover:text-dark-ui-accent-bg/80"
                            />
                            <Editable
                                ref="newFolderInput"
            ...
            <template #cell-basename="{ row: asset, checkboxId }">
                ...
                >
                    ...
                    />
                    <button
                        class="cursor-pointer normal-nums select-none group-hover:text-ui-accent-bg/80 dark:group-hover:text-dark-ui-accent-bg/80 text-start"
