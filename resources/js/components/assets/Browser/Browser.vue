                        ...
                        <div class="card overflow-hidden p-0" :class="{ 'select-none' : shifting }">
                            <div class="relative w-full">
                                ...
                                <div class="flex items-center justify-between p-2 text-sm">
                                    ...
                                    <button v-if="canCreateFolders" class="btn btn-sm ms-3" @click="creatingFolder = true">
                                        <svg-icon name="folder-add" class="h-4 w-4 me-2" />
                                        <span>{{ __('Create Folder') }}</span>
                                    </button>

                                    <button v-if="canUpload" class="btn btn-sm ms-3" @click="openFileBrowser">
                                        <svg-icon name="upload" class="h-4 w-4 me-2 text-current" />
                                        <span>{{ __('Upload') }}</span>
                                    </button>
                            ...
                            >
                                    ...
                                    <tr v-if="folder && folder.parent_path && !restrictFolderNavigation">
                                        ...
                                        <td @click="selectFolder(folder.parent_path)">
                                            <a class="flex items-center cursor-pointer group">
                                                <file-icon extension="folder" class="w-8 h-8 me-2 inline-block text-blue-400 group-hover:text-blue" />
                                                ..
                                            </a>
                                        </td>
                                ...
                                <template slot="cell-basename" slot-scope="{ row: asset, checkboxId }">
                                    <div class="flex items-center w-fit-content group">
                                        <asset-thumbnail :asset="asset" :square="true" class="w-8 h-8 me-2 cursor-pointer" @click.native.stop="$emit('edit-asset', asset)" />
                                ...
                                <div class="asset-grid-listing px-4 pt-2">
                                    ...
                                    <div class="asset-tile group relative" v-for="(folder, i) in folders" :key="folder.path" v-if="!restrictFolderNavigation">
                                        ...
                                        <dropdown-list v-if="folderActions(folder).length"
                                            class="absolute top-1 end-2 opacity-0 group-hover:opacity-100"
