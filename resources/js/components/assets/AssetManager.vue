<template>
    ...
    <div class="asset-manager">
        ...
        <div class="flex items-center mb-6">
            ...
            <dropdown-list v-if="container.can_edit || container.can_delete" class="ms-4">
                <dropdown-item
            ...
            <a :href="createContainerUrl" class="btn ms-4" v-if="canCreateContainers">{{ __('Create Container') }}</a>
        </div>
