        ...
        >
            ...
            <template v-if="!loading">
                ...
                <header id="asset-editor-header" class="relative flex w-full justify-between px-2">
                    ...
                    >
                        <ui-icon name="folder-photos" class="size-5 group-hover:text-ui-accent/80 dark:group-hover:text-dark-ui-accent/80" />
                        <span class="text-sm group-hover:text-ui-accent/80 dark:text-gray-400 dark:group-hover:text-gray-200">
                            {{ asset.path }}
                        </span>
                    </button>
