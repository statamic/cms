        ...
        <template v-if="!loading">
            ...
            <div id="asset-editor-header" class="flex justify-between w-full px-2 relative">
                <button class="flex items-center p-4 group" @click="open" v-tooltip.right="__('Open in a new window')" :aria-label="__('Open in a new window')">
                    ...
                    <span class="rtl:mr-2 ltr:ml-2 text-sm text-gray-800 group-hover:text-blue">{{ asset.path }}</span>
                    <svg-icon name="micro/chevron-right" class="text-gray-700 h-5 w-5 group-hover:text-blue rtl:rotate-180" />
                </button>
            ...
            <div class="flex flex-1 flex-col md:flex-row md:justify-between grow overflow-scroll">
                ...
                <!-- Visual Area -->
                <div class="editor-preview bg-gray-800 rtl:md:rounded-tl-md ltr:md:rounded-tr-md flex flex-col justify-between flex-1 min-h-[45vh] md:min-h-auto md:flex-auto md:grow w-full md:w-1/2 lg:w-2/3 shadow-[inset_0px_4px_3px_0px_black]">
            ...
            <div class="bg-gray-200 w-full border-t flex items-center justify-end py-3 px-4 rounded-b">
                <div id="asset-meta-data" class="flex-1 hidden sm:flex space-x-3 py-1 h-full text-xs text-gray-800">
                    <div class="flex items-center bg-gray-400 rounded py-1 rtl:pr-2 ltr:pl-2 rtl:pl-3 ltr:pr-3" v-if="isImage">
                    ...
                    <div class="flex items-center bg-gray-400 rounded py-1 rtl:pr-2 ltr:pl-2 rtl:pl-3 ltr:pr-3">
