<template>
    <div>
        <div class="flex items-center mb-6">
            ...
            <a :href="addon.url" target="_blank" class="btn me-4" v-text="__('View on Marketplace')" />
            ...
            <div class="card mb-6 flex items-center">
                ...
                <div class="flex-1 text-lg">
                    ...
                    <a :href="addon.seller.website" class="relative flex items-center">
                        <img :src="addon.seller.avatar" :alt="addon.seller.name" class="rounded-full w-6 me-2">
