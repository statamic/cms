        ...
        <div>
            <div class="card mb-6 flex items-center">
                <div class="flex-1 text-lg">
                    <div class="little-heading p-0 mb-2 text-grey-700" v-text="__('Price')" />
                    <div class="font-bold" v-text="priceRange" />
                </div>
                <div class="flex-1 text-lg">
                    <div class="little-heading p-0 mb-2 text-grey-700" v-text="__('Seller')" />
                ...
                <div class="flex-1 text-lg" v-if="downloads">
                    <div class="little-heading p-0 mb-2 text-grey-700" v-text="__('Downloads')" />
