...
export const colors = [
    ...
    { name: 'chart-1-label-bg', label: 'Chart 1 Label', },
    { name: 'chart-2-label-bg', label: 'Chart 2 Label', },
    { name: 'chart-3-label-bg', label: 'Chart 3 Label', },
    { name: 'chart-4-label-bg', label: 'Chart 4 Label', },
    { name: 'chart-5-label-bg', label: 'Chart 5 Label', },
    { name: 'chart-1-legend', label: 'Chart 1 Legend', },
    { name: 'chart-2-legend', label: 'Chart 2 Legend', },
    { name: 'chart-3-legend', label: 'Chart 3 Legend', },
    { name: 'chart-4-legend', label: 'Chart 4 Legend', },
    { name: 'chart-5-legend', label: 'Chart 5 Legend', },
