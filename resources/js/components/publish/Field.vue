...
export default {
    ...
    computed: {
        ...
        instructions() {
            return this.config.instructions ? this.renderMarkdownAndLinks(__(this.config.instructions)) : null;
        },
        ...
        labelText() {
            return this.config.display || titleize(deslugify(this.config.handle));
        },
        ...
        showLabel() {
            return (
                this.showLabelText || // Need to see the text
