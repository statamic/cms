<template>
    ...
    <div>
        ...
        <button class="btn flex w-full justify-center items-center" @click="open = true">
            <svg-icon name="light/hyperlink" class="me-2 w-4 h-4" />
                        ...
                        <v-select
                            ...
                            <template slot="option" slot-scope="option">
                                <div class="flex items-center">
                                    <span v-text="option.fieldset" class="text-2xs text-gray-500 dark:text-dark-150 me-2" />
                                    <span v-text="option.label" />
                                </div>
                            </template>
                            <template v-slot:no-options>
                               <div class="text-sm text-gray-700 dark:text-dark-200 text-start py-2 px-4" v-text="__('No options to choose from.')" />
                           </template>
                        </v-select>
                        <button
