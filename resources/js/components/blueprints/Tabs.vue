<template>
    <div>
        <div v-if="!singleTab && tabs.length > 0" class="tabs-container relative">
            <div ref="tabs" class="tabs flex-1 flex space-x-3 rtl:space-x-reverse overflow-auto pe-6" role="tablist">
                <tab
                    ref="tab"
                    v-for="tab in tabs"
                    :key="tab._id"
            ...
            <div class="fade-right end-10" />
            <button class="btn-round ms-2 flex items-center justify-center relative top-1" @click="addAndEditTab" v-tooltip="addTabText">
