<template>
    <ui-card class="py-0.75! px-2! field-grid-item blueprint-section-field" :class="widthClass">
        <div class="flex items-center gap-2">
            <ui-icon name="handles" class="blueprint-drag-handle size-4 cursor-grab text-gray-300 dark:text-gray-700" />
            <div class="flex flex-1 items-center justify-between">
                <div class="flex flex-1 items-center py-2">
                    ...
                    />
                    <div class="flex items-center gap-2">
                        <button class="cursor-pointer overflow-hidden text-ellipsis text-sm hover:text-blue-600 dark:hover:text-blue-400 text-start" type="button" v-text="__(labelText)" @click="$emit('edit')" />
