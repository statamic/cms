        ...
        <div class="flex items-center gap-2">
            ...
            <div class="flex flex-1 items-center justify-between">
                <div class="flex flex-1 items-center py-2">
                    ...
                    />
                    <div class="flex items-center gap-2">
                        <button class="cursor-pointer overflow-hidden text-ellipsis text-sm hover:text-ui-accent/80 dark:hover:text-dark-ui-accent/80 text-start" type="button" v-text="__(labelText)" @click="$emit('edit')" />
