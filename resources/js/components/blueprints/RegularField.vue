        ...
        <div class="blueprint-section-field-inner">
            ...
            <div class="flex flex-1 items-center justify-between">
                ...
                <div class="flex-none rtl:pl-2 ltr:pr-2 flex">
                    ...
                    <div v-else class="relative border border-gray-400 opacity-50 w-12 flex items-center justify-center rtl:ml-2 ltr:mr-2">
                        <svg-icon name="regular/hidden" class="h-4 w-4 opacity-50"></svg-icon>
                    </div>

                    <button v-if="canDefineLocalizable"
                        class="hover:text-gray-950 rtl:ml-2 ltr:mr-2 flex items-center"
                    ...
                    <button @click.prevent="$emit('duplicate')" class="text-gray-600 hover:text-gray-950 flex items-center rtl:ml-2 ltr:mr-2" v-tooltip="__('Duplicate')">
