<template>
    ...
    >
        <div class="blueprint-section-card card p-0 h-full flex rounded-t flex-col">
            ...
            <div class="bg-grey-200 border-b text-sm flex rounded-t" v-if="!isSingle">
                ...
                <div class="p-3 py-2 flex-1">
                    ...
                    <span class="font-mono text-xs text-grey-700 mr-2">
                ...
                <div class="flex items-center px-3">
                    <button @click.prevent="toggleEditing" class="flex items-center text-grey-600 hover:text-grey-950 mr-2">
                        <svg-icon class="h-4 w-4" :name="isEditing ? 'shrink' : 'expand'" />
                    </button>
                    <button @click.prevent="$emit('deleted')" class="flex items-center text-grey-600 hover:text-grey-950" v-if="deletable">
            ...
            >
                <template v-slot:empty-state>
                    <div
                        ...
                        class="text-2xs text-grey-600 text-center border border-dashed rounded mb-2 p-2"
                    />
                </template>
            </fields>
