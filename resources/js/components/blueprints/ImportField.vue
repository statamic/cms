                ...
                <div class="flex items-center gap-2">
                    ...
                    <div class="flex flex-1 items-center justify-between">
                        <div class="flex flex-1 items-center py-2">
                            <ui-icon class="size-4 me-2 text-ui-accent-bg/80 dark:text-dark-ui-accent-bg/80" name="fieldsets" />
                            <div class="flex items-center gap-2">
                            <!-- @TODO: Show fieldset.title -->
                                <button class="cursor-pointer overflow-hidden text-ellipsis text-sm text-ui-accent-bg hover:text-ui-accent-bg/80 dark:text-dark-ui-accent-bg dark:hover:text-dark-ui-accent-bg/80" v-text="field.fieldset" @click="$emit('edit')" />
