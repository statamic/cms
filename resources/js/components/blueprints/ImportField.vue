        ...
        <div class="blueprint-section-field-inner">
            ...
            <div class="flex flex-1 items-center justify-between">
                <div class="flex items-center flex-1 rtl:pl-4 ltr:pr-4 py-2 rtl:pr-2 ltr:pl-2">
                    <svg-icon class="flex-none text-gray-700 h-4 w-4 rtl:ml-2 ltr:mr-2" name="paperclip" v-tooltip="__('Linked fieldset')" />
                    <a class="break-all" @click="$emit('edit')">
                        <span v-text="__('Fieldset')" />
                        <span class="font-mono text-3xs text-gray-600 rtl:mr-2 ltr:ml-2">{{ field.fieldset }}</span>
                    </a>
                </div>
