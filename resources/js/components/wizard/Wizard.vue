    ...
    <div class="max-w-xl mx-auto rounded shadow bg-white">
        ...
        <div v-if="currentStep === 0">
            ...
            <div class="max-w-md mx-auto pb-7">
                ...
                <input type="text" v-model="handle" class="input-text">
                <div class="text-2xs text-grey-light mt-1 flex items-center">
                    <div class="mr-sm flex items-center mb-px">@svg('info-circle')</div>
        ...
        <div v-if="currentStep === 1">
            <div class="max-w-md mx-auto py-6 text-center">
                ...
                <div class="my-4">
                    <input class="mx-2" type="radio" name="sort" v-model="sort" value="date" /> Date
                    <input class="mx-2" type="radio" name="sort" v-model="sort" value="alphabetical" /> Alpha
                    <input class="mx-2" type="radio" name="sort" v-model="sort" value="numerical" /> Numerical
                </div>
            </div>
        </div>
        ...
        <div class="border-t p-2">
            <div class="max-w-md mx-auto flex items-center justify-center">
                <button class="btn-primary mx-2 w-32" @click="previous" v-if="! onFirstStep">
                    &larr; {{ __('Previous')}}
                </button>
                <button class="btn-primary mx-2 w-32" :disabled="! canContinue" @click="next" v-if="! onLastStep">
                    {{ __('Next')}} &rarr;
                </button>
            </div>
        </div>
