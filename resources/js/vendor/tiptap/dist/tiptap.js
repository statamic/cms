...
(function (global, factory) {
    ...
    _createClass(Editor, [{
      ...
      value: function createState() {
        ...
        return prosemirrorState.EditorState.create({
          ...
          plugins: _toConsumableArray(this.plugins).concat([prosemirrorInputrules.inputRules({
      ...
      value: function createDocument(content) {
        ...
        if (typeof content === 'string') {
          ...
          return prosemirrorModel.DOMParser.fromSchema(this.schema).parse(element);
        }
      ...
      value: function setContent() {
        ...
        this.state = prosemirrorState.EditorState.create({
      ...
      value: function setActiveNodesAndMarks() {
        ...
        this.activeMarks = Object.entries(this.schema.marks).reduce(function (marks, _ref2) {
          ...
          return _objectSpread({}, marks, _defineProperty({}, name, function () {
            ...
            return tiptapUtils.markIsActive(_this4.state, mark, attrs);
          }));
        }, {});
        this.activeMarkAttrs = Object.entries(this.schema.marks).reduce(function (marks, _ref4) {
          ...
          return _objectSpread({}, marks, _defineProperty({}, name, tiptapUtils.getMarkAttrs(_this4.state, mark)));
        }, {});
        this.activeNodes = Object.entries(this.schema.nodes).reduce(function (nodes, _ref6) {
          ...
          return _objectSpread({}, nodes, _defineProperty({}, name, function () {
            var attrs = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
            return tiptapUtils.nodeIsActive(_this4.state, node, attrs);
          }));
        }, {});
      }
    }, {
  ...
  exports.Plugin = prosemirrorState.Plugin;
  exports.PluginKey = prosemirrorState.PluginKey;
  exports.TextSelection = prosemirrorState.TextSelection;
  exports.NodeSelection = prosemirrorState.NodeSelection;
