...
const index = ref(`${props.taxonomy.handle}/index`);
const show = ref(`${props.taxonomy.handle}/show`);
...
<template>
    <Head :title="[__('Scaffold Views'), __(taxonomy.title), __('Taxonomies')]" />
    ...
    <Panel :heading="__('messages.taxonomy_scaffold_instructions')">
