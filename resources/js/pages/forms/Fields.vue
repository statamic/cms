                ...
                <div class="space-y-7" :data-fields-collapsed="fieldView === 'collapsed' ? 'true' : null">
                            ...
                            <Field :label="__('How long have you been a fan?')" :instructions="__('If you don\'t remember, just give your best estimate.')">
                                <template #label>
                                    <Label for="fan-length-field">
                                        <span class="inline-flex flex-wrap items-center gap-x-2 gap-y-1">
                                            <Icon name="text-short" data-collapsed-field-icon class="size-3.5 rounded-sm bg-purple-50 text-purple-500 dark:bg-purple-950 dark:text-purple-400" aria-hidden="true" />
                    ...
                    <Field :label="__('Which album was your favorite?')">
                        <template #label>
                            <Label>
                                <span class="inline-flex flex-wrap items-center gap-x-2 gap-y-1">
                                    <Icon name="fieldtype-radio" data-collapsed-field-icon class="size-3.5 rounded-sm bg-orange-50 text-orange-600 dark:bg-orange-950 dark:text-orange-400" aria-hidden="true" />
                    ...
                    <div data-fieldset-group class="space-y-7">
                        ...
                        <Field :label="__('Sign up for email notifications from The Midnight')">
                            <template #label>
                                <Label>
                                    <span class="inline-flex flex-wrap items-center gap-x-2 gap-y-1">
                                        <Icon name="fieldtype-checkboxes" data-collapsed-field-icon class="size-3.5 rounded-sm bg-orange-50 text-orange-600 dark:bg-orange-950 dark:text-orange-400" aria-hidden="true" />
                        ...
                        <div id="fieldset-end">
                            <Field id="age-field" :label="__('How old are you?')">
                                <template #label>
                                    <Label for="age-field">
                                        <span class="inline-flex flex-wrap items-center gap-x-2 gap-y-1">
                                            <Icon name="number" data-collapsed-field-icon class="size-3.5 rounded-sm bg-teal-50 text-teal-500 dark:bg-teal-950 dark:text-teal-400" aria-hidden="true" />
                                            {{ __('How old are you?') }}
                                        </span>
                                    </Label>
                                </template>
                    ...
                    <Field :label="__('I want a free drink voucher')">
                        <template #label>
                            <Label>
                                <span class="inline-flex flex-wrap items-center gap-x-2 gap-y-1">
                                    <Icon name="fieldtype-toggle" data-collapsed-field-icon class="size-3.5 rounded-sm bg-orange-50 text-orange-600 dark:bg-orange-950 dark:text-orange-400" aria-hidden="true" />
