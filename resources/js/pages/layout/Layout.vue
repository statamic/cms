...
makeResizable(leftPanelRef, leftPanelActive, { edge: 'right', minWidth: 240, maxWidth: 450, defaultWidth: 320 });
makeResizable(rightPanelRef, rightPanelActive, { edge: 'left', minWidth: 240, maxWidth: 450, defaultWidth: 320 });
    ...
    <ConfigProvider>
        ...
        <main id="main" class="flex bg-body-bg dark:border-t dark:border-body-border rounded-t-2xl fixed top-14 inset-x-0 bottom-0 min-h-[calc(100vh-3.5rem)]">
            ...
            >
                ...
                <div v-show="leftPanelActive" data-left-panel ref="leftPanel" id="left-panel" tabindex="-1" class="focus:outline-none relative layout-left-panel overflow-y-scroll overflow-x-clip grid pe-2 min-h-full mx-auto">
                </div>
