...
<Canvas of={ComboboxStories._DocsIntro} sourceState={'shown'} />
...
<Canvas of={ComboboxStories._Taggable} sourceState={'shown'} />

## Disable Search
By default, the combobox is searchable. You may disable search by setting the `searchable` prop to `false`.
<Canvas of={ComboboxStories._SearchDisabled} sourceState={'shown'} />
...
<Canvas of={ComboboxStories._OptionSlots} sourceState={'shown'} />
...
<Canvas of={ComboboxStories._AdaptiveWidth} sourceState={'shown'} />
