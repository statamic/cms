...
return [
    ...
    'gt' => [
        'numeric' => 'Muss grösser als :value sein.',
        'file' => 'Muss grösser als :value Kilobyte sein.',
        'string' => 'Muss grösser als :value Zeichen sein.',
        'array' => 'Muss mehr als :value Elemente haben.',
    ],
    'gte' => [
        'numeric' => 'Muss grösser oder gleich :value sein.',
        'file' => 'Muss grösser oder gleich :value Kilobyte sein.',
        'string' => 'Muss grösser oder gleich :value Zeichen sein.',
        'array' => 'Muss :value oder mehr Elemente haben.',
    ],
    ...
    'lt' => [
        ...
        'file' => 'Muss kleiner als :value Kilobyte sein.',
        'string' => 'Muss aus weniger als :value Zeichen bestehen.',
        'array' => 'Muss weniger als :value Elemente enthalten.',
    ],
    'lte' => [
        'numeric' => 'Muss kleiner oder gleich :value sein.',
        'file' => 'Muss kleiner oder gleich :value Kilobyte sein.',
        'string' => 'Muss kleiner oder gleich :value Zeichen sein.',
        'array' => 'Darf nicht mehr als :value Elemente enthalten.',
    ],
    'max' => [
        'numeric' => 'Darf nicht grösser als :max sein.',
        'file' => 'Darf nicht grösser als :max kilobytes sein.',
        'string' => 'Darf nicht mehr als :max Zeichen haben.',
    ...
    'min' => [
        ...
        'file' => 'Muss mindestens :min Kilobyte sein.',
        'string' => 'Muss mindestens :min Zeichen haben.',
        'array' => 'Muss mindestens :min Elemente enthalten.',
    ],
    ...
    'size' => [
        'numeric' => 'Muss :size sein.',
        'file' => 'Muss :size Kilobyte sein.',
        'string' => 'Muss :size Zeichen haben.',
        'array' => 'Muss :size Elemente enthalten.',
    ],
