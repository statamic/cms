...
return [
    ...
    'between' => [
        ...
        'file' => 'Debe estar entre :min y :max kb.',
    ...
    'gt' => [
        ...
        'file' => 'Debe ser mayor que :value kb.',
        'string' => 'Debe ser mayor que :value caracteres de :value.',
        'array' => 'Debe tener más de :value artículos de :value.',
    ],
    'gte' => [
        'numeric' => 'Debe ser mayor o igual que :value.',
        'file' => 'Debe ser mayor o igual :value kb.',
        'string' => 'Debe ser mayor o igual que :value caracteres de :value.',
        'array' => 'Debe tener :value artículos de :value o más.',
    ],
    ...
    'lt' => [
        ...
        'file' => 'Debe ser menor que :value kb.',
        'string' => 'Debe ser menor que :value caracteres de :value.',
        'array' => 'Debe tener menos de :value artículos de :value.',
    ],
    'lte' => [
        'numeric' => 'Debe ser menor o igual :value.',
        'file' => 'Debe ser menor o igual :value kb.',
        'string' => 'Debe ser menor o igual :value caracteres de :value.',
        'array' => 'No debe tener más de :value artículos de :value.',
    ],
    'max' => [
        'numeric' => 'No puede ser mayor que :max.',
        'file' => 'No puede ser mayor que :max kb :max.',
        'string' => 'No puede ser mayor que :max caracteres :max.',
        'array' => 'No puede tener más de :max artículos :max.',
    ],
    'mimes' => 'Debe ser un archivo de tipo :values.',
    'mimetypes' => 'Debe ser un archivo de tipo :values.',
    'min' => [
        'numeric' => 'Debe ser al menos :min.',
        'file' => 'Debe ser al menos :min kb.',
        'string' => 'Debe ser al menos :min caracteres mínimos.',
        'array' => 'Debe tener al menos :min artículos mínimos.',
    ],
    ...
    'size' => [
        ...
        'array' => 'Debe contener :size artículos de :size.',
    ],
