...
return [
    ...
    'publish_actions_schedule' => 'Changes to the working copy will be applied to the entry and it will appear published on the selected date.',    'publish_actions_schedule_revision' => 'A revision will be created based off the working copy and published on the selected date.',
