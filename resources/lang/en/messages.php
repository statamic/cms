...
return [
    ...
    'collection_wizard_blueprints_instructions' => 'If you choose multiple Blueprints, users will be able to select from one when creating entries. The first will be the default.',
    'collection_wizard_content_model_intro' => 'Your content model determines what field and data are stored in this collection.',
    ...
    'collection_wizard_structure_instructions' => 'Choosing a structure will let your page hierarchy dictate its URLs.',
    ...
    'collection_wizard_taxonomies_instructions' => 'Entries in this collection may be related to terms in these taxonomies. Fields will be automatically added to publish forms.',
    'collection_wizard_template_instructions' => 'Set your default template.',
    'collection_wizard_title_instructions' => 'Usually a plural noun, like "Articles", "Products", or "Breakfast Foods".',
    ...
    'form_wizard_blueprint_instructions' => 'You can pick an existing Blueprint or create a new one.',
    ...
    'form_wizard_handle_instructions' => 'How you\'ll reference to this form in your templates. Cannot easily be changed.',
    ...
    'form_wizard_title_instructions' => 'Usually a call to action, like "Contact Us" or "Vote for Your Favorite Porg".',
    ...
    'structure_wizard_handle_instructions' => 'How you\'ll reference to this structure in your templates. Cannot easily be changed.',
    ...
    'taxonomy_wizard_blueprint_instructions' => 'You can pick an existing Blueprint or creates a new one.',
    'taxonomy_wizard_collections_instructions' => 'When a collection is linked to a taxonomy, its entries will automatically get fields added to their forms.',
    'taxonomy_wizard_collections_intro' => 'Create the links between taxonomy and collection.',
    'taxonomy_wizard_content_model_intro' => 'Your content model determines what field and data are stored in this taxonomy.',
    'taxonomy_wizard_handle_instructions' => 'How you\'ll reference this taxonomy in your templates. Cannot be easily changed.',
    ...
    'taxonomy_wizard_title_instructions' => 'Usually a noun, like "Categories" or "Tags".',
