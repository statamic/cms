...
return [
    ...
    'asset_container_disk_instructions' => 'Filesystem disks specify where files are stroed — either locally or in a remote location like Amazon S3. They can be configured in `config/filesystems.php`',
    ...
    'blueprints_button_help_text' => 'Blueprints can be customized once created.',
    ...
    'collection_configure_content_model_intro' => 'The content model determines what fields and behaviors define this collection.',
    'collection_configure_dates_intro' => 'Configure the date behaviors.',
    ...
    'collection_configure_order_intro' => 'Choose the Collection should be ordered.',
    ...
    'collection_configure_route_instructions' => 'Routes are optional, for when entries need their own URLs.',
    ...
    'collection_configure_structure_route_instructions' => 'A route is required when choosing a structure. `parent_uri` and `depth` are also available.',
    ...
    'collection_next_steps_scaffold_description' => 'Quickly generate empty blueprints and frontend views based on the name of the collection.',
    ...
    'fieldsets_button_help_text' => 'Fieldsets can be customized once created.',
    ...
    'global_set_handle_instructions' => 'How to reference this global set in templates, etc.',
    ...
    'licensing_trial_mode_alert' => 'You have licensing issues to resolve before moving to production.',
    'licensing_production_alert' => 'Please purchase and enter your license key or risk violating the License Agreement.',
