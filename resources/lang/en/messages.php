...
return [
    ...
    'collections_post_message_data_instructions' => 'This data will be sent to the iFrame using `window.postMessage()`. The value can either be a string or JSON data.',
    ...
    'taxonomies_use_post_message_instructions' => 'Post a message to the iFrame instead of hard reloading the page.',
    'taxonomies_post_message_data_instructions' => 'This data will be sent to the iFrame using `window.postMessage()`. The value can either be a string or JSON data.',
