...
return [
    ...
    'disable_two_factor_authentication_current_user_optional' => 'This action will render both your authenticator and back-up codes invalid, and will allow complete access to your account using only it\'s password.',
    'disable_two_factor_authentication_current_user_enforced' => 'You will be logged out <strong>immediately</strong>, and will need to set up two factor authentication again on your next login.',
    'disable_two_factor_authentication_other_user_optional' => 'This action will render both their authenticator and back-up codes invalid, and will allow complete access to their account using only it\'s password.',
    'disable_two_factor_authentication_other_user_enforced' => 'They will be logged out <strong>immediately</strong>, and will need to set up two factor authentication again on their next login.',
