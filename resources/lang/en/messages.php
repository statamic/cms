...
return [
    ...
    'two_factor_enable_introduction' => 'When two factor authentication is enabled, you will be prompted for a token during authentication. You may retrieve this token from your phone\'s authenticator application, such as Google Authenticator or password managers like 1Password.',
    'two_factor_locked_introduction' => 'This user\'s account has been locked due to too many failed two factor challenge attempts.',
    'two_factor_unlock_confirm_1' => 'Unlocking this account will allow the user to attempt to log in again.',
    'two_factor_unlock_confirm_2' => 'It may also be useful to have them reset their password, and even reset their two factor authentication setup as a precaution.',
    'two_factor_unlock_confirm_3' => 'Are you sure you want to do this?',
    ...
    'two_factor_recovery_codes_footnote' => 'Store these recovery codes in a secure password manager. They can be used to recover access to your account if your two factor authentication device is lost.',
    'two_factor_regenerate_recovery_codes_1' => 'Regenerating your recovery codes will invalidate all previously created recovery codes with immediate effect.',
    'two_factor_regenerate_recovery_codes_2' => 'Are you sure you want to do this?',
    'two_factor_reset_me_intro_1' => 'This will remove all two factor authentication details from your account.',
    'two_factor_reset_me_intro_2' => 'You can set up two factor authentication again from your Profile in the Control Panel.',
    'two_factor_reset_me_enforced_intro_1' => 'This will remove all two factor authentication details from your account, and log you out.',
    'two_factor_reset_me_enforced_intro_2' => 'The next time you log in, you will need to set up two factor authentication again before you can access the Control Panel.',
    'two_factor_reset_user_intro_1' => 'This will remove all two factor authentication details from their account.',
    'two_factor_reset_user_intro_2' => 'They will be able to enable two factor authentication from their Profile in the Control Panel.',
    'two_factor_reset_user_enforced_intro_1' => 'This will remove all two factor authentication details from their account, and log them out.',
    'two_factor_reset_user_enforced_intro_2' => 'The next time they log in, they will need to set up two factor authentication again before they can access the Control Panel.',
    'two_factor_reset_confirm_me_1' => 'This will remove all two factor authentication details from your account.',
    'two_factor_reset_confirm_me_2' => 'You can set up two factor authentication from your Profile in the Control Panel.',
    'two_factor_reset_confirm_me_3' => 'Are you really sure you want to do this?',
    'two_factor_reset_confirm_me_enforced_1' => 'This will remove all two factor authentication details from your account, and log you out <strong>immediately</strong>.',
    'two_factor_reset_confirm_me_enforced_2' => 'You will need to set up two factor authentication on your next log in.',
    'two_factor_reset_confirm_me_enforced_3' => 'Are you really sure you want to do this?',
    'two_factor_reset_confirm_user_1' => 'This will remove all two factor authentication details from their account.',
    'two_factor_reset_confirm_user_2' => 'They can set up two factor authentication from their Profile in the Control Panel.',
    'two_factor_reset_confirm_user_3' => 'Are you really sure you want to do this?',
    'two_factor_reset_confirm_user_enforced_1' => 'This will remove all two factor authentication details from their account, and log them out on their next visit.',
    'two_factor_reset_confirm_user_enforced_2' => 'They will need to set up two factor authentication on their next log in.',
    'two_factor_reset_confirm_user_enforced_3' => 'Are you really sure you want to do this?',
    ...
    'two_factor_not_enabled' => 'Two Factor Authentication is not enabled for this site.',
