...
return [
    ...
    'edit_other_authors_{collection}_entries' => "Edit other authors' :collection entries",
    'publish_other_authors_{collection}_entries' => "Publish other authors' :collection entries",
    'delete_other_authors_{collection}_entries' => "Delete other authors' :collection entries",
