...
return [
    ...
    'color.title' => 'Color',
    'date.config.calendar' => 'Please select any calendar from the list or none of them.',
    ...
    'date.config.locale' => 'Please specify the locale in which you want your calendar to be displayed. If you haven\'t selected a specific calendar here or in the site\'s settings, the calendar may default to the locale\'s standard calendar.',
    ...
    'date.config.timezone' => 'If you have a preferred timezone that is different from the user\'s default, please specify it here.',
    'date.title' => 'Date',
