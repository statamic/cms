...
return [
    ...
    'blueprints_button_help_text' => 'Vous pourrez personnaliser votre plan une fois qu’il aura été créé.',
    ...
    'collection_wizard_blueprints_instructions' => "Si vous choisissez plusieurs Blueprints, les utilisateurs pourront en sélectionner un lors de la création d'entrées. Le premier sera le défaut.",
    ...
    'collection_wizard_ordered_date_ascending' => 'Les entrées seront triées du plus ancien au plus récent (inhabituel).',
    'collection_wizard_ordered_date_descending' => 'Les entrées seront triées du plus récent au plus ancien.',
    'collection_wizard_ordered_sequentially_ascending' => 'Les entrées seront triées du plus bas au plus élevé.',
    'collection_wizard_ordered_sequentially_descending' => 'Les entrées seront triées du plus haut au plus bas.',
    ...
    'collections_future_date_behavior_instructions' => 'Comment les futures entrées datées devraient se comporter.',
    ...
    'collections_past_date_behavior_instructions' => 'Comment les entrées datées doivent se comporter.',
    ...
    'fieldsets_button_help_text' => 'Vous pourrez personnaliser votre Fieldset une fois qu’il aura été créé.',
    ...
    'session_expiry_enter_password' => "Entrez votre mot de passe pour continuer là où vous l'avez laissé",
    ...
    'tab_sections_instructions' => 'Les champs de chaque section seront regroupés dans des onglets. Créez de nouveaux champs, réutilisez des champs existants ou importez des groupes entiers de champs à partir d&#39;ensembles de champs existants.',
