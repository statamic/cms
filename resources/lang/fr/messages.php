...
return [
    ...
    'collection_configure_require_slugs_instructions' => 'S’il faut exiger que les entrées aient chacune un identifiant.',
    ...
    'collection_configure_title_format_instructions' => 'Définissez ceci pour que les entrées de cette collection génèrent automatiquement leurs titres.',
    ...
    'licensing_trial_mode_alert' => 'Ce site utilise Statamic Pro et des addons commerciaux. Assurez-vous d\'acheter des licences avant de lancer. Merci!',
    'licensing_trial_mode_alert_addons' => 'Ce site utilise des addons commerciaux. Assurez-vous d\'acheter des licences avant de lancer. Merci!',
    'licensing_trial_mode_alert_statamic' => 'Ce site utilise Statamic Pro. Assurez-vous d\'acheter une licence avant de lancer. Merci!',
    ...
    'show_slugs_instructions' => 'S’il faut afficher les identifiants dans la vue arborescente.',
    ...
    'user_wizard_super_admin_instructions' => 'Les super-admin ont le contrôle complet et l’accès à tout ce qui se trouve dans le Panneau de configuration. Accordez ce rôle à bon escient.',
];
