...
return [
    ...
    'site_configure_handle_instructions' => 'Une référence unique à ce site. Il n’est pas évident de le modifier ultérieurement.',
    'site_configure_lang_instructions' => 'En savoir plus sur les [Langues](https://statamic.dev/multi-site#language).',
    'site_configure_locale_instructions' => 'En savoir plus sur les [Locales](https://statamic.dev/multi-site#locale).',
    ...
    'tabs_instructions' => 'Les champs de chaque section seront regroupés sous forme d’onglets. Créez de nouveaux champs, réutilisez des champs existants ou importez des groupes entiers de champs à partir de Fieldsets existants.',
    ...
    'user_groups_handle_instructions' => 'Utilisé pour référencer ce groupe d’utilisateurs sur le frontal. Il n’est pas évident de le modifier par la suite.',
    ...
    'user_wizard_email_instructions' => 'L’email sert également de nom d’utilisateur et doit être unique.',
    ...
    'user_wizard_name_instructions' => 'Laissez le nom vide pour permettre à l’utilisateur de le remplir.',
