...
return [
    ...
    'addon_list_loading_error' => 'Noe gikk galt under lasting av utvidelse. Prøv igjen senere.',
    'asset_container_allow_uploads_instructions' => 'Når det er aktivert, kan brukere laste opp filer til denne beholderen.',
    'asset_container_blueprint_instructions' => 'Blueprint definerer ytterligere tilpassede felt som er tilgjengelige ved redigering av medier.',
    ...
    'asset_container_quick_download_instructions' => 'Når dette er aktivert, blir en knapp for hurtignedlasting lagt til i Asset Manager.',
    ...
    'collection_configure_title_format_instructions' => 'Angi dette for at oppføringene i denne samlingen skal generere titlene automatisk. Les mer i [documentation](https://statamic.dev/collections#titles).',
    ...
    'collections_amp_instructions' => 'Aktiver Accelerated Mobile Pages (AMP). Legger automatisk til ruter og URL for oppføringer i denne samlingen. Les mer i [documentation](https://statamic.dev/amp)',
    ...
    'collections_mount_instructions' => 'Velg en oppføring som denne samlingen skal monteres på. Les mer i [documentation](https://statamic.dev/collections-and-entries#mounting).',
    ...
    'collections_preview_targets_instructions' => 'URL-ene som skal kunne vises i forhåndsvisning. Les mer i [documentation](https://statamic.dev/live-preview#preview-targets).',
    'collections_route_instructions' => 'Ruten styrer oppføringenes URL-mønster. Les mer i [documentation](https://statamic.dev/collections#routing).',
    ...
    'email_utility_configuration_description' => 'Mailinnstillinger er konfigurert i <code>:path</code>',
    'email_utility_description' => 'Sjekk konfigurasjonsinnstillinger for mail, og send testmailer.',
    ...
    'forgot_password_enter_email' => 'Oppgi mailadressen din, så sender vi deg en lenke for tilbakestilling av passord.',
    ...
    'form_configure_email_html_instructions' => 'Visning av HTML-versjonen av denne mailen.',
    'form_configure_email_markdown_instructions' => 'Gjengi HTML-versjonen av mailen ved hjelp av Markdown.',
    'form_configure_email_attachments_instructions' => 'Knytt opplastede vedlegg til denne mailen.',
    'form_configure_email_instructions' => 'Konfigurer mailene som skal sendes når den nye skjemainnsendelsen mottas.',
    'form_configure_email_reply_to_instructions' => 'La stå tomt for å gå tilbake til avsenderen.',
    'form_configure_email_subject_instructions' => 'Mailens emnelinje.',
    'form_configure_email_text_instructions' => 'Visningen til tekstversjonen av denne mailen.',
    'form_configure_email_to_instructions' => 'Mottakerens mailadresse.',
    ...
    'form_configure_store_instructions' => 'Deaktiver for å stanse lagring av innsendelser. Varsler og mail-meldinger vil fortsatt bli sendt.',
    ...
    'git_nothing_to_commit' => 'Ingenting å utføre, innholdsbanene er rene!',
    ...
    'password_protect_token_missing' => 'Sikkerhetstoken mangler. Du må komme til denne skjermen via den opprinnelige, sikrede URL-en.',
    ...
    'role_title_instructions' => 'Vanligvis et substantiv i entall, f.eks. Editor eller Admin.',
    ...
    'taxonomies_preview_targets_instructions' => 'URL-ene som skal kunne vises i forhåndsvisning. Les mer i [documentation](https://statamic.dev/live-preview#preview-targets).',
    ...
    'taxonomy_next_steps_create_term_description' => 'Opprett den første betingelsen eller lag en håndfull plassholderbetingelser, det er opp til deg.',
    ...
    'user_wizard_email_instructions' => 'Mailadressen fungerer også som brukernavn og må være unik.',
    ...
    'user_wizard_invitation_intro' => 'Send en velkomstmail med informasjon om kontoaktivering til den nye brukeren.',
