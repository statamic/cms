...
return [
    ...
    'between' => [
        'array' => 'Musi mieć pomiędzy :min a :max elementów.',
        'file' => 'Musi mieć pomiędzy :min a :max kilobajtów.',
        'numeric' => 'Musi znajdować się pomiędzy :min a :max.',
        'string' => 'Musi mieć pomiędzy :min a :max znaków.',
    ],
    ...
    'gt' => [
        'array' => 'Musi mieć więcej niż :value elementów.',
        'file' => 'Musi być większy niż :value kilobajtów.',
        'numeric' => 'Musi być większe niż :value.',
        'string' => 'Musi mieć więcej niż :value znaków.',
    ],
    'gte' => [
        'array' => 'Musi mieć :value lub więcej elementów.',
        'file' => 'Musi być większy lub równy :value kilobajtów.',
        'numeric' => 'Musi być większe lub równe :value.',
        'string' => 'Musi mieć :value znaków lub więcej.',
    ],
    ...
    'lt' => [
        'array' => 'Musi mieć mniej niż :value elementów.',
        'file' => 'Musi mieć mniej niż :value kilobajtów.',
        'numeric' => 'Musi być mniejsze niż :value.',
        'string' => 'Musi mieć mniej niż :value znaków.',
    ],
    'lte' => [
        'array' => 'Nie może mieć więcej niż :value elementów.',
        'file' => 'Musi być mniejsze lub równe :value kilobajtów.',
        'numeric' => 'Musi być mniejsze lub równe :value.',
        'string' => 'Musi mieć :value lub mniej znaków.',
    ],
    'mac_address' => 'Musi być prawidłowym adresem MAC.',
    'max' => [
        'numeric' => 'Nie może być większe niż :max.',
        'file' => 'Nie może być większy niż :max kilobajtów.',
        'string' => 'Nie może mieć więcej niż :max znaków.',
    ...
    'min' => [
        'numeric' => 'Musi być co najmniej :min.',
        'file' => 'Musi mieć co najmniej :min kilobajtów.',
        'string' => 'Musi mieć co najmniej :min znaków.',
        'array' => 'Musi mieć co najmniej :min elementów.',
    ],
    ...
    'size' => [
        'numeric' => 'Musi być równy :size.',
        'file' => 'Musi mieć rozmiar równy :size kilobajtów.',
        'string' => 'Musi mieć długość równą :size znaków.',
