...
return [
    ...
    'cheatsheet' => '
<p>Markdown هو تنسيق تعليمات برمجية لتحويل النص إلى HTML للكتّاب على الويب. يتيح لك Markdown الكتابة باستخدام تنسيق نصي سهل القراءة وسهل الكتابة يتم تحويله إلى HTML صالح من الناحية الهيكلية.</p>
...
<h3>التنسيق الغامق والمائل</h3>
<pre class="language-markdown"><code>يمكنك جعل النص *مميزًا*، **غامقًا**، أو _**كلاهما**_.</code></pre>

<h3>الروابط</h3>
<pre class="language-markdown"><code>هذه [رابط مثال](http://example.com).</code></pre>
...
<pre class="language-markdown"><code>- لحم
- شريحة لحم
- عصير</code></pre>
