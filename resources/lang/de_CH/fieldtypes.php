...
return [
    ...
    'assets.config.min_files' => 'Minimale Anzahl der auswählbaren Dateien festlegen.',
    ...
    'bard.config.enable_input_rules' => 'Bei der Eingabe werden Markdown-ähnliche Abkürzungen automatisch formatiert (z.B. wird \*\*fett\*\* zu **fett**).',
    'bard.config.enable_paste_rules' => 'Beim Einfügen werden Markdown-ähnliche Abkürzungen automatisch formatiert (z.B. wird \*\*fett\*\* zu **fett**).',
    ...
    'code.config.line_wrapping' => 'Lange Zeilen sollen in die nächste Zeile umgebrochen werden, anstatt horizontal zu scrollen.',
    ...
    'date.config.number_of_months' => 'Festlegen, wie viele Monate gleichzeitig angezeigt werden sollen.',
    ...
    'html.config.html_instruct' => 'HTML-Code verwalten, der in der Eingabemaske angezeigt werden soll. Dies dient nur zu Anzeigezwecken, der HTML-Code wird nicht gespeichert.',
    'html.title' => 'HTML',
    ...
    'replicator.config.sets' => 'Sets sind konfigurierbare Blöcke von Feldern, die nach Belieben erstellt und neu angeordnet werden können.',
    ...
    'terms.config.taxonomies' => 'Auswählen, aus welchen Taxonomien Begriffe angezeigt werden sollen.',
    ...
    'width.config.size' => 'Zwischen grossen und Standard-UI-Grössen wählen.',
    'yaml.title' => 'YAML',
];
