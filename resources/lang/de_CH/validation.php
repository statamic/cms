...
return [
    ...
    'between.array' => 'Muss zwischen :min und :max Elemente enthalten.',
    ...
    'min.file' => 'Muss mindestens :min Kilobyte gross sein.',
    ...
    'prohibits' => ':other darf nicht vorhanden sein.',
    'regex' => 'Das Format ist ungültig.',
    'required' => 'Dieses Feld ist erforderlich.',
    'required_array_keys' => 'Einträge für :values erforderlich.',
    'required_if' => 'Dieses Feld ist erforderlich, wenn :other den Wert :value hat.',
    'required_if_accepted' => 'Dieses Feld ist erforderlich, wenn :other akzeptiert wurde.',
    'required_unless' => 'Dieses Feld ist erforderlich, es sei denn, :other befindet sich in :values.',
    ...
    'required_without_all' => 'Dieses Feld ist erforderlich, wenn keiner der Werte in :values vorhanden ist.',
   ...
   'slug' => 'Darf nur Buchstaben und Zahlen enthalten, Bindestriche oder Unterstriche dienen als Trenner.',
    ...
    'origin_cannot_be_disabled' => 'Es kann keine deaktivierte Quelle ausgewählt werden.',
    'parent_cannot_be_itself' => 'Kann nicht sein eigenes übergeordnetes Element sein.',
    'parent_causes_root_children' => 'Dadurch würde die Startseite Unterseiten erhalten.',
    'parent_exceeds_max_depth' => 'Dadurch würde die maximale Tiefe überschritten.',
    ...
    'asset_file_exists_same_content' => 'Eine Datei mit diesem Namen existiert bereits und hat denselben Inhalt. Möglicherweise möchtest du diese löschen, statt sie umzubenennen.',
    'asset_file_exists_different_content' => 'Eine Datei mit diesem Namen existiert bereits, enthält jedoch andere Inhalte. Möglicherweise möchtest du stattdessen die vorhandene Datei durch diese ersetzen.',
