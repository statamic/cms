...
return [
    ...
    'view_{collection}_entries' => '查看:collection条目',
    'edit_{collection}_entries' => '编辑条目',
    'create_{collection}_entries' => '创建新条目',
    'delete_{collection}_entries' => '删除条目',
    'publish_{collection}_entries' => '管理发布状态',
    ...
    'view_{taxonomy}_terms' => '查看:taxonomy术语',
    'edit_{taxonomy}_terms' => '编辑术语',
    'create_{taxonomy}_terms' => '创建新术语',
    ...
    'view_{container}_assets' => '查看:container资源',
    'upload_{container}_assets' => '上传新资源',
    'edit_{container}_assets' => '编辑资源',
