...
return [
    ...
    'view_{collection}_entries' => 'Visa :collection',
    'edit_{collection}_entries' => 'Redigera poster',
    'create_{collection}_entries' => 'Skapa nya poster',
    'delete_{collection}_entries' => 'Ta bort poster',
    'publish_{collection}_entries' => 'Hantera publiceringsstatus',
    'publish_{collection}_entries_desc' => 'Möjlighet att ändra från utkast till publicerat och vice versa',
    'reorder_{collection}_entries' => 'Ordna om poster',
    'reorder_{collection}_entries_desc' => 'Möjliggör omordning av dra och släpp',
    ...
    'view_{taxonomy}_terms' => 'Visa :taxonomy',
    'edit_{taxonomy}_terms' => 'Redigera villkor',
    'create_{taxonomy}_terms' => 'Skapa nya villkor',
    ...
    'upload_{container}_assets' => 'Ladda upp nya tillgångar',
    'edit_{container}_assets' => 'Redigera tillgångar',
    ...
    'delete_users' => 'Ta bort användare',
