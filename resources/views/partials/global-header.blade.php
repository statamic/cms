<header class="global-header">
    <div class="lg:min-w-xl pl-1 md:pl-2 h-full flex items-center">
        <button class="nav-toggle md:block ml-sm flex-shrink-0" @click="toggleNav" aria-label="{{ __('Toggle Nav') }}">@cp_svg('burger')</button>
