    ...
    <div class="head-link h-full rtl:md:pl-6 ltr:md:pr-6 flex items-center justify-end">
        ...
        <dropdown-list v-cloak>
            <template v-slot:trigger>
                <button class="hidden md:block h-6 w-6 rtl:mr-4 ltr:ml-4 p-1 text-gray dark:text-dark-100 hover:text-gray-800 dark:hover:text-dark-175" v-tooltip="__('Preferences')" aria-label="{{ __('Manage Preferences') }}">
        ...
        <dropdown-list v-cloak>
            <template v-slot:trigger>
                <a class="dropdown-toggle items-center rtl:mr-4 ltr:ml-4 h-full hide flex relative group">
                    @if ($user->avatar())
