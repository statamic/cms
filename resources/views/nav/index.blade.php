...
@section('content')
    ...
    <div class="card p-0 mb-4">
        <table class="data-table">
            <tr>
                ...
                <td class="text-end text-2xs text-gray-500">
    ...
    @if (Statamic\Facades\Role::all()->isNotEmpty())
        <h3 class="little-heading ps-0 mb-2">{{ __('Override For Role') }}</h3>
        <div class="card p-0 mb-4">
            <table class="data-table">
                @foreach (Statamic\Facades\Role::all() as $role)
                    <tr>
                        <td>
                            <div class="flex items-center">
                                <div class="w-4 h-4 me-4">@cp_svg('icons/light/shield-key')</div>
    ...
    <h3 class="little-heading ps-0 mb-2">{{ __('Override For User') }}</h3>
    <div class="card p-0 mb-4">
        <table class="data-table">
            <tr>
                <td>
                    <div class="flex items-center">
                        <div class="w-4 h-4 me-4">@cp_svg('icons/light/user')</div>
