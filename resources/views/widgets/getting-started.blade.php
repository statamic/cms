<div class="card p-0 content">
    ...
    <div class="flex flex-wrap p-4___REPLACED">
        <a href="https://statamic.dev" class="w-full lg:w-1/2 p-4___REPLACED flex items-start hover:bg-grey-20 rounded-md group">
        ...
        @if (!Statamic::pro())
        <a href="https://statamic.dev/licensing" class="w-full lg:w-1/2 p-4___REPLACED flex items-start hover:bg-grey-20 rounded-md group">
            <div class="h-8 w-8 mr-4___REPLACED text-grey-80">
                @cp_svg('pro-ribbon')
            </div>
            <div class="flex-1">
        ...
        @endif
        <a href="{{ cp_route('collections.create') }}" class="w-full lg:w-1/2 p-4___REPLACED flex items-start hover:bg-grey-20 rounded-md group">
            <div class="h-8 w-8 mr-4___REPLACED text-grey-80">
        ...
        <a href="{{ cp_route('blueprints.index') }}" class="w-full lg:w-1/2 p-4___REPLACED flex items-start hover:bg-grey-20 rounded-md group">
            <div class="h-8 w-8 mr-4___REPLACED text-grey-80">
                @cp_svg('blueprints')
            </div>
            <div class="flex-1">
        ...
        <a href="{{ cp_route('navigation.create') }}" class="w-full lg:w-1/2 p-4___REPLACED flex items-start hover:bg-grey-20 rounded-md group">
            <div class="h-8 w-8 mr-4___REPLACED text-grey-80">
