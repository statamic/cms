<div class="card p-5 content mb-5">
    <div class="flex">
        <div class="max-w-lg pr-4">
            <h1 class="mb-2 text-3xl">
                {{ $product ?? null }} Updates
            </h1>
            ...
            <p><a href="{{ Statamic::docsUrl('installation#updating') }}" class="font-bold text-blue">Learn more about updates in the docs</a><span class="inline-block text-blue w-4 h-4 ml-1">@svg('external-link')</span></p>
        </div>
