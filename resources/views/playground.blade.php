...
@section('content')
    ...
    <div class="shadow bg-white p-8 rounded-lg mb-16">
        ...
        <div class="mb-4 flex">
            ...
            <select class="ms-2" name="" id="">
                <option value="">Oh hai Mark</option>
            </select>
        </div>
        <div class="mb-4 flex">
            <input type="text" class="input-text" placeholder="v3 style">
            <button class="btn ms-2">Default Button</button>
            <button class="btn-primary ms-2">Primary Button</button>
        </div>
        <div class="mb-4">
    ...
    <div class="shadow bg-white p-8 rounded-lg mb-16">
        ...
        <div class="mb-8 flex">
            <button class="me-4 btn">Default Button</button>
            <button class="me-4 btn-primary">Primary Button</button>
            <button class="me-4 btn-danger">Danger Button</button>
        ...
        <div class="mb-8 flex">
            <button disabled class="me-4 btn disabled">Default Button</button>
            <button disabled class="me-4 btn-primary disabled">Primary Button</button>
            <button disabled class="me-4 btn-danger disabled">Danger Button</button>
            <button disabled class="btn-flat disabled">Flat Button</button>
        </div>

        <h6 class="mb-4">Large</h6>
        <div class="mb-8 flex">
            <button class="me-4 btn btn-lg">Default Button</button>
            <button class="me-4 btn-primary btn-lg">Primary Button</button>
            <button class="me-4 btn-danger btn-lg">Danger Button</button>
            <button class="btn-flat btn-lg">Flat Button</button>
        </div>

        <h6 class="mb-4">Small</h6>
        <div class="flex">
            <button class="me-4 btn btn-xs">Default Button</button>
            <button class="me-4 btn-primary btn-xs">Primary Button</button>
            <button class="me-4 btn-danger btn-xs">Danger Button</button>
        ...
        <div class="w-1/3 px-4">
            <div class="card px-6">
                ...
                <div class="flex items-center ">
                    <span class="w-4 h-4 text-green-500 me-2">@cp_svg('icons/light/performance-increase')</span>
