@php
    ...
    $icons = collect(File::files(base_path('vendor/statamic/cms/resources/svg/icons')))
        ->map(function ($file) {
...
@section('content')
    ...
    <div class="space-y-12">
        ...
        <section class="space-y-4">
            ...
            <div class="flex items-center justify-center rounded-xl border border-gray-200 bg-gray-50 p-12">
        ...
        <section class="space-y-4">
            ...
            <div class="grid grid-cols-4 gap-4 md:grid-cols-6 2xl:grid-cols-10">
                @foreach ($icons as $icon)
                    <div class="flex flex-col items-center gap-3 rounded-lg bg-gray-50 px-2 py-6">
        ...
        <section class="space-y-4">
            ...
            <div class="flex rounded-xl border border-gray-200 bg-gray-50 p-4">
                <ui-splitter-group>
