...
@section('content')
    ...
    <div class="card">
        <form method="POST" action="{{ cp_route('utilities.email') }}">
            ...
            <div class="flex items-center">
                <input class="input-text me-4" type="text" name="email" value="{{ old('email', $user->email()) }}" />
    ...
    <div class="card p-0">
        <table class="data-table">
            <tr>
                <th class="ps-4 py-2 w-1/4">{{ __('Default Mailer') }}</th>
                <td><code>{{ config('mail.default') }}</code></td>
            </tr>
            @if (config('mail.default') == 'smtp')
            <tr>
                <th class="ps-4 py-2 w-1/4">{{ __('Host') }}</th>
                <td><code>{{ config('mail.mailers.smtp.host') }}</code></td>
            </tr>
            <tr>
                <th class="ps-4 py-2 w-1/4">{{ __('Port') }}</th>
                <td><code>{{ config('mail.mailers.smtp.port') }}</code></td>
            </tr>
            <tr>
                <th class="ps-4 py-2 w-1/4">{{ __('Encryption') }}</th>
                <td>
            ...
            <tr>
                <th class="ps-4 py-2 w-1/4">{{ __('Username') }}</th>
                <td>
            ...
            <tr>
                <th class="ps-4 py-2 w-1/4">{{ __('Password') }}</th>
                <td>
            ...
            <tr>
                <th class="ps-4 py-2 w-1/4">{{ __('Sendmail') }}</th>
                <td><code>{{ config('mail.mailers.sendmail.path') }}</code></td>
            </tr>
            @endif
            <tr>
                <th class="ps-4 py-2 w-1/4">{{ __('Default From Address') }}</th>
                <td>
            ...
            <tr>
                <th class="ps-4 py-2 w-1/4">{{ __('Default From Name') }}</th>
                <td>
            ...
            <tr>
                <th class="ps-4 py-2 w-1/4">{{ __('Markdown theme') }}</th>
                <td>
            ...
            <tr>
                <th class="ps-4 py-2 w-1/4">{{ __('Markdown paths') }}</th>
                <td>
