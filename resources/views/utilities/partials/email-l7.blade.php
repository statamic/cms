<tr>
    <th class="pl-2 py-2___REPLACED w-1/4">{{ __('Default Mailer') }}</th>
    <td><code>{{ config('mail.default') }}</code></td>
</tr>
@if (config('mail.default') == 'smtp')
<tr>
    <th class="pl-2 py-2___REPLACED w-1/4">{{ __('Host') }}</th>
    <td><code>{{ config('mail.mailers.smtp.host') }}</code></td>
</tr>
<tr>
    <th class="pl-2 py-2___REPLACED w-1/4">{{ __('Port') }}</th>
    <td><code>{{ config('mail.mailers.smtp.port') }}</code></td>
</tr>
<tr>
    <th class="pl-2 py-2___REPLACED w-1/4">{{ __('Encryption') }}</th>
    <td>
...
<tr>
    <th class="pl-2 py-2___REPLACED w-1/4">{{ __('Username') }}</th>
    <td>
...
<tr>
    <th class="pl-2 py-2___REPLACED w-1/4">{{ __('Password') }}</th>
    <td>
...
<tr>
    <th class="pl-2 py-2___REPLACED w-1/4">{{ __('Sendmail') }}</th>
