    ...
    <div class="card p-0">
        <div class="p-4">
            <div class="flex justify-between items-center">
                ...
                <div class="flex">
                    <form method="POST" action="{{ cp_route('utilities.cache.warm', 'stache') }}" class="me-2">
                        @csrf
            ...
            <div class="text-sm text-gray dark:text-dark-150 flex">
                <div class="me-4 badge-pill-sm"><span class="text-gray-800 dark:text-dark-150 font-medium">{{ __('Records') }}:</span> {{ $stache['records'] }}</div>
                @if($stache['size'])
                    <div class="me-4 badge-pill-sm"><span class="text-gray-800 dark:text-dark-150 font-medium">{{ __('Size') }}:</span> {{ $stache['size'] }}</div>
                @endif
                @if ($stache['time'])
                    <div class="me-4 badge-pill-sm"><span class="text-gray-800 dark:text-dark-150 font-medium">{{ __('Build time') }}:</span> {{ $stache['time'] }}</div>
                @endif
                @if ($stache['rebuilt'])
        ...
        <div class="p-4 bg-gray-200 dark:bg-dark-700 border-t dark:border-dark-900">
            ...
            <div class="text-sm text-gray dark:text-dark-150 flex">
                <div class="me-4 badge-pill-sm bg-white dark:bg-dark-700 border dark:border-dark-900"><span class="text-gray-800 dark:text-dark-150 font-medium">{{ __('Strategy') }}:</span> {{ $static['strategy'] }}</div>
                @if ($static['enabled'])
                    <div class="me-4 badge-pill-sm bg-white dark:bg-dark-700 border dark:border-dark-900"><span class="text-gray-800 dark:text-dark-150 font-medium">{{ __('Pages') }}:</span> {{ $static['count'] }}</div>
                @endif
            </div>
        </div>
        ...
        <div class="p-4 border-t dark:border-dark-900">
            ...
            <div class="text-sm text-gray dark:text-dark-150 flex">
                <div class="me-4 badge-pill-sm"><span class="text-gray-800 dark:text-dark-150 font-medium">{{ __('Driver') }}:</span> {{ $cache['driver'] }}</div>
            </div>
        </div>
        ...
        <div class="p-4 border-t dark:border-dark-900 bg-gray-200 dark:bg-dark-700 rounded-b">
            ...
            <div class="text-sm text-gray dark:text-dark-150 flex">
                <div class="me-4 badge-pill-sm bg-white dark:bg-dark-700 border dark:border-dark-900"><span class="text-gray-800 dark:text-dark-150 font-medium">{{ __('Cached images') }}:</span> {{ $images['count'] }}</div>
                <div class="me-4 badge-pill-sm bg-white dark:bg-dark-700 border dark:border-dark-900"><span class="text-gray-800 dark:text-dark-150 font-medium">{{ __('Size') }}:</span> {{ $images['size'] }}</div>
            </div>
        </div>
    </div>
