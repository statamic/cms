        ...
        <div class="flex flex-wrap md:-mx-6 mt-6">
            <div class="w-full md:w-1/2 md:px-6 mb-6">
                <div class="card p-0 content border-t-6 border-blue">
                    <div class="p-6">
                        <h2><a href="{{ cp_route('blueprints.index') }}" class="text-grey-900 hover:text-blue">{{ __('Blueprints') }}</a></h2>
                    ...
                    <div class="flex p-6 border-t items-center">
                        ...
                        @unless($blueprints->isEmpty())
                            <a href="{{ cp_route('blueprints.index') }}" class="font-bold text-blue text-sm hover:text-grey-900">
                ...
                <div class="card p-0 content border-t-6 border-blue">
                    ...
                    <div class="flex p-6 border-t items-center">
                        ...
                        @unless($fieldsets->isEmpty())
                            <a href="{{ cp_route('fieldsets.index') }}" class="font-bold text-blue text-sm hover:text-grey-900">
