            ...
            <div class="w-full md:w-1/2 md:px-6 mb-6">
                <div class="card p-0 content border-t-6 border-blue">
                    <div class="p-6">
                        ...
                        <p><a href="{{ Statamic::docsUrl('blueprints') }}" class="font-bold text-blue">{{ __('Read the Docs') }}</a><span class="inline-block text-blue w-4 h-4 ms-2">@cp_svg('icons/light/external-link')</span></p>
                    </div>
                    <div class="flex p-6 border-t items-center">
                        <a href="{{ cp_route('blueprints.create') }}" class="btn-primary me-4">{{ __('Create Blueprint') }}</a>
            ...
            <div class="w-full md:w-1/2 md:px-6 mb-6">
                <div class="card p-0 content border-t-6 border-blue">
                    <div class="p-6">
                        ...
                        <p><a href="{{ Statamic::docsUrl('fieldsets') }}" class="font-bold text-blue">{{ __('Read the Docs') }}</a><span class="inline-block text-blue w-4 h-4 ms-2">@cp_svg('icons/light/external-link')</span></p>
                    </div>
                    <div class="flex p-6 border-t items-center">
                        <a href="{{ cp_route('fieldsets.create') }}" class="btn-primary me-4">{{ __('Create Fieldset') }}</a>
