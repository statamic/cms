                    ...
                    <tr>
                        <td>
                            <div class="flex items-center">
                                ...
                                <span class="little-dot {{ $blueprint->hidden() ? 'hollow' : 'bg-green' }} mr-2" v-tooltip="'{{ __($blueprint->hidden() ? 'Hidden': 'Visible') }}'"></span>
    ...
    @foreach (Statamic\Facades\Nav::all() as $nav)
        ...
        @endif
                <tr>
                    <td>
                        <div class="flex items-center">
                            <div class="w-4 h-4 mr-4">@cp_svg('hierarchy-files')</div>
    ...
    @foreach (Statamic\Facades\GlobalSet::all() as $set)
        ...
        @endif
                <tr>
                    <td>
                        <div class="flex items-center">
                            <div class="w-4 h-4 mr-4">@cp_svg('earth')</div>
    ...
    @foreach (Statamic\Facades\AssetContainer::all() as $container)
        ...
        @endif
                <tr>
                    <td>
                        <div class="flex items-center">
                            <div class="w-4 h-4 mr-4">@cp_svg('assets')</div>
    ...
    @foreach (Statamic\Facades\Form::all() as $form)
        ...
        @endif
                <tr>
                    <td>
                        <div class="flex items-center">
                            <div class="w-4 h-4 mr-4">@cp_svg('drawer-file')</div>
    ...
    <div class="card p-0 mb-4">
        <table class="data-table">
            <tr>
                <td>
                    <div class="flex items-center">
                        <div class="w-4 h-4 mr-4">@cp_svg('users')</div>
