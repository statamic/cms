                    ...
                    <tr>
                        <td>
                            <div class="flex items-center">
                                <div class="w-4 h-4 mr-4">@cp_svg('icons/default/content-writing')</div>
        ...
        @endif
                @foreach ($taxonomy->termBlueprints() as $blueprint)
                    <tr>
                        <td>
                            <div class="flex items-center">
                                <div class="w-4 h-4 mr-4">@cp_svg('icons/default/tags')</div>
                                <span class="little-dot {{ $blueprint->hidden() ? 'hollow' : 'bg-green-600' }} mr-2" v-tooltip="'{{ __($blueprint->hidden() ? 'Hidden': 'Visible') }}'"></span>
    ...
    @foreach (Statamic\Facades\Nav::all() as $nav)
        ...
        @endif
                <tr>
                    <td>
                        <div class="flex items-center">
                            <div class="w-4 h-4 mr-4">@cp_svg('icons/default/hierarchy-files')</div>
    ...
    @foreach (Statamic\Facades\GlobalSet::all() as $set)
        ...
        @endif
                <tr>
                    <td>
                        <div class="flex items-center">
                            <div class="w-4 h-4 mr-4">@cp_svg('icons/default/earth')</div>
    ...
    @foreach (Statamic\Facades\AssetContainer::all() as $container)
        ...
        @endif
                <tr>
                    <td>
                        <div class="flex items-center">
                            <div class="w-4 h-4 mr-4">@cp_svg('icons/default/assets')</div>
    ...
    @foreach (Statamic\Facades\Form::all() as $form)
        ...
        @endif
                <tr>
                    <td>
                        <div class="flex items-center">
                            <div class="w-4 h-4 mr-4">@cp_svg('icons/default/drawer-file')</div>
    ...
    <div class="card p-0 mb-4">
        <table class="data-table">
            <tr>
                <td>
                    <div class="flex items-center">
                        <div class="w-4 h-4 mr-4">@cp_svg('icons/default/users')</div>
