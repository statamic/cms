...
import { $ as Item_default, An as require_clike, At as Stack_default, B as throttle_default, Cn as require_yaml, Dn as require_gfm, En as require_javascript, Mn as require_sublime, Nn as require_matchbrackets, On as require_markdown, Tn as require_htmlmixed, Vn as require_codemirror, _n as useContentDirection, et as Group_default, jn as require_css, kn as require_xml, pi as Button_default, wn as require_php } from "./ui-CU4LF2an.js";
import { g as purify, l as _Renderer, u as marked } from "./globals-_ahzGsLE.js";
import { F as Uploads_default, I as Uploader_default, d as availableButtons, g as Selector_default, h as dedupeInFlight, v as Fieldtype_default } from "./index-CCk14Dcr.js";
	...
	methods: {
		...
		*/
		assetsSelected(assets) {
			...
			this.selectedAssets = [];
			dedupeInFlight("assets-fieldtype", JSON.stringify([...assets].slice().sort()), () => this.$axios.post(cp_url("assets-fieldtype"), { assets })).then(({ data }) => {
				data.forEach((asset) => {
