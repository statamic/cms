import { At as toDisplayString, B as openBlock, C as createVNode, K as resolveComponent, S as createTextVNode, W as renderList, _ as createBlock, b as createSlots, f as Fragment, g as createBaseVNode, it as withCtx, v as createCommentVNode, y as createElementBlock } from "./vue.esm-bundler-FaDyk5AC.js";
import { t as _plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-BOaGB7Aw.js";
import { Ei as Icon_default, Tt as Pagination_default } from "./ui-C4XItfuR.js";
import { D as DateFormatter } from "./api-BxWlqlVX.js";
...
function _sfc_render$1(_ctx, _cache, $props, $setup, $data, $options) {
	...
	return openBlock(), createElementBlock("div", _hoisted_1$1, [
		createVNode(_component_ui_header, {
			...
			name: "actions",
			fn: withCtx(() => [createTextVNode(toDisplayString($data.currentVersion) + " ", 1), $data.onLatestVersion ? (openBlock(), createBlock(_component_ui_badge, {
				key: 0,
				text: _ctx.__("Up to date"),
				color: "green",
				size: "lg",
				icon: "checkmark"
			}, null, 8, ["text"])) : $data.securityUpdateAvailable ? (openBlock(), createBlock(_component_ui_badge, {
				key: 1,
