import { At as toDisplayString, B as openBlock, C as createVNode, G as renderSlot, J as resolveDynamicComponent, L as onMounted, M as mergeProps, W as renderList, Y as toHandlers, _ as createBlock, f as Fragment, g as createBaseVNode, v as createCommentVNode, y as createElementBlock } from "./vue.esm-bundler-FaDyk5AC.js";
import { t as _plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-BOaGB7Aw.js";
import { r as colorMode } from "./api-wG-DH_vw.js";
import { c as useStatamicPageProps, o as useBodyClasses, s as PortalTargets_default } from "./index-CaF3D-v6.js";
//#region resources/svg/statamic-logo-lime.svg
var _hoisted_1$1 = {
...
function render(_ctx, _cache) {
	return openBlock(), createElementBlock("svg", _hoisted_1$1, [..._cache[0] || (_cache[0] = [
		...
		createBaseVNode("path", {
			d: "M47.49 69.34c.93-1.21 2-1.74 3.21-1.74 1.34 0 2.67.54 4.01 1.48 4.27 2.82 9.08 4.43 14.83 4.43 4.41 0 7.88-1.88 7.88-5.63 0-9.79-32.46-4.43-32.46-26.43 0-11.81 9.62-18.38 22.04-18.38 8.82 0 15.23 2.55 20.04 5.63 1.2.8 2 2.41 2 4.02 0 .94-.27 1.88-.8 2.68l-1.47 2.15c-1.07 1.48-2.27 2.15-3.74 2.15-1.07 0-2.14-.4-3.34-.94-3.61-1.88-7.35-2.82-11.89-2.82s-7.48 2.55-7.48 5.23c0 10.06 32.46 4.56 32.46 25.89 0 11.94-9.62 19.32-24.31 19.32-9.35 0-16.16-2.82-22.44-8.32-1.07-.94-1.47-2.15-1.47-3.35 0-.94.27-2.01.94-2.82l2-2.55z",
			style: { "fill-rule": "nonzero" }
		}, null, -1)
	])]);
}
var statamic_logo_lime_default = { render };
//#endregion
//#region resources/js/pages/layout/Outside.vue
var _sfc_main = {
	__name: "Outside",
	setup(__props, { expose: __expose }) {
		...
		onMounted(() => {
			...
			if (userMode === null || userMode === void 0 || userMode === "undefined") userMode = "auto";
		...
		const __returned__ = {
			...
			showLogo,
			get StatamicLogo() {
				return statamic_logo_lime_default;
			},
			get useBodyClasses() {
			...
			PortalTargets: PortalTargets_default
		};
...
var _hoisted_1 = { class: "relative mx-auto max-w-[400px] items-center justify-center" };
var _hoisted_2 = {
	key: 0,
	class: "flex items-center justify-center py-6"
};
var _hoisted_3 = { class: "logo max-w-3/4 md:pt-18" };
var _hoisted_4 = ["src", "alt"];
var _hoisted_5 = ["src", "alt"];
var _hoisted_6 = ["textContent"];
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
	return openBlock(), createElementBlock("div", _hoisted_1, [
		$setup.showLogo ? (openBlock(), createElementBlock("div", _hoisted_2, [createBaseVNode("div", _hoisted_3, [$setup.customLogo ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [createBaseVNode("img", {
			src: $setup.lightCustomLogo,
			alt: $setup.cmsName,
			class: "white-label-logo dark:hidden"
		}, null, 8, _hoisted_4), createBaseVNode("img", {
			src: $setup.darkCustomLogo,
			alt: $setup.cmsName,
			class: "white-label-logo hidden dark:block"
		}, null, 8, _hoisted_5)], 64)) : $setup.logos.text ? (openBlock(), createElementBlock("div", {
			key: 1,
			class: "mx-auto mb-8 max-w-xs text-center text-lg font-medium opacity-50",
			textContent: toDisplayString($setup.logos.text)
		}, null, 8, _hoisted_6)) : $setup.isCpRoute ? (openBlock(), createBlock($setup["StatamicLogo"], {
			key: 2,
			class: "h-6"
		})) : createCommentVNode("", true)])])) : createCommentVNode("", true),
		renderSlot(_ctx.$slots, "default"),
		createVNode($setup["PortalTargets"]),
		(openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.$root.appendedComponents, (component) => {
			return openBlock(), createBlock(resolveDynamicComponent(component.name), mergeProps({ key: component.id }, { ref_for: true }, component.props, toHandlers(component.events)), null, 16);
		}), 128))
	]);
}
var Outside_default = /*#__PURE__*/ _plugin_vue_export_helper_default(_sfc_main, [["render", _sfc_render], ["__file", "Outside.vue"]]);
//#endregion
export { Outside_default as default };
