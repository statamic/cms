...
import { F as onBeforeUnmount, H as provide, L as onMounted, O as h, R as onUnmounted, T as defineComponent, _t as ref, et as watch, f as Fragment, h as computed, ht as reactive, i as createSSRApp, pt as markRaw, yt as shallowRef } from "./vue.esm-bundler-FaDyk5AC.js";
...
var hasOwnInPrototypeChain = (thing, prop) => {
	...
	while (obj != null && obj !== Object.prototype) {
		...
		seen.push(obj);
		if (hasOwnProperty$14(obj, prop)) return true;
...
function merge$1(...objs) {
	...
	for (let i = 0, l = objs.length; i < l; i++) {
		...
		for (let j = 0; j < symbols.length; j++) {
			...
			if (propertyIsEnumerable$2.call(source, symbol)) assignValue(source[symbol], symbol);
		}
	}
	return result;
}
...
var { propertyIsEnumerable: propertyIsEnumerable$2 } = Object.prototype;
/**
