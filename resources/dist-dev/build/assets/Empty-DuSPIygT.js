import { At as toDisplayString, B as openBlock, C as createVNode, K as resolveComponent, W as renderList, _ as createBlock, f as Fragment, g as createBaseVNode, it as withCtx, v as createCommentVNode, y as createElementBlock } from "./vue.esm-bundler-FaDyk5AC.js";
...
var _hoisted_4 = { class: "flex flex-wrap gap-2 mt-2" };
		...
		createVNode(_component_ui_empty_state_menu, { heading: _ctx.__("Start designing your collection with these steps") }, {
			default: withCtx(() => [
				...
				$props.canCreate ? (openBlock(), createElementBlock(Fragment, { key: 1 }, [$props.blueprints.length > 1 ? (openBlock(), createBlock(_component_ui_empty_state_item, {
					...
					default: withCtx(() => [createBaseVNode("div", _hoisted_4, [(openBlock(true), createElementBlock(Fragment, null, renderList($props.blueprints, (blueprint) => {
