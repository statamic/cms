import { B as openBlock, C as createVNode, Dt as normalizeClass, G as renderSlot, K as resolveComponent, W as renderList, _ as createBlock, _t as ref, f as Fragment, g as createBaseVNode, h as computed, it as withCtx, u as withModifiers, v as createCommentVNode, y as createElementBlock } from "./vue.esm-bundler-FaDyk5AC.js";
import { t as _plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-BOaGB7Aw.js";
import { $t as Item_default, A as BeforeSaveHooks, F as Components_default, I as Container_default, Jt as Separator_default, L as Tabs_default, M as PipelineStopped, N as Request, Vt as Header_default, Zt as Menu_default, en as Dropdown_default, j as Pipeline, k as AfterSaveHooks, pi as Button_default, u as ItemActions_default, v as clone } from "./ui-CU4LF2an.js";
import { P as HasActions_default, r as Head_default } from "./index-CCk14Dcr.js";
	...
	methods: {
		...
		switchToLocalization(localization) {
			...
			this.$axios.get(localization.url).then((response) => {
				...
				if (this.publishContainer === "base" && localization.url) window.history.replaceState({}, "", localization.url + window.location.hash);
...
var _hoisted_1 = { class: "items-center gap-2 sm:gap-3 md:flex" };
var _hoisted_2 = {
	key: 0,
	...
	return openBlock(), createElementBlock("div", null, [
		createVNode(_component_Header, {
			...
			default: withCtx(() => [
				...
				createBaseVNode("div", _hoisted_1, [$props.canEdit ? (openBlock(), createBlock(_component_Button, {
					key: 0,
					variant: "primary",
					text: _ctx.__("Save"),
		...
		$data.fieldset && !$data.fieldset.empty ? (openBlock(), createBlock(_component_PublishContainer, {
			...
			"track-dirty-state": $data.trackDirtyState,
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
	return openBlock(), createElementBlock("div", {
		class: normalizeClass($props.asConfig ? "max-w-page mx-auto" : "max-w-5xl 3xl:max-w-6xl mx-auto"),
		"data-max-width-wrapper": ""
	}, [createVNode($setup["Head"], { title: _ctx.__("Edit Global Set") }, null, 8, ["title"]), createVNode($setup["GlobalPublishForm"], {
