const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./dist-DVqm2P-T.js","./rolldown-runtime-B-1-B7_t.js","./view-DKtc-YdG.js","./dist-D1jI0QqO.js","./dist-BGVo02xK.js","./Set-EFB2JDwO.js","./_plugin-vue_export-helper-BOaGB7Aw.js","./index-CaF3D-v6.js","./preload-helper-CW7Fztz1.js","./ui-C6seNKvP.js","./index.esm-DPorNqrr.js","./vue.esm-bundler-FaDyk5AC.js","./globals-_ahzGsLE.js","./api-wG-DH_vw.js","./ui-D13LqCiu.css","./index-5JDWlls6.css","./state-CfMmplvw.js","./model-hNPyj5Wv.js"])))=>i.map(i=>d[i]);
...
import { At as Stack_default, Cr as hide, Di as Icon_default, Dr as size, Er as shift, Nt as Content_default, Sr as flip, Tr as offset, _n as useContentDirection, br as autoPlacement, jt as Footer_default, pi as Button_default, wr as inline, xr as computePosition, yn as containerContextKey, yr as arrow$2, zt as Input_default } from "./ui-C6seNKvP.js";
import { t as __vitePreload } from "./preload-helper-CW7Fztz1.js";
import { h as nanoid, s as data_get } from "./globals-_ahzGsLE.js";
import { A as require_tiny_emitter } from "./api-wG-DH_vw.js";
import { _ as Asset_default, g as Selector_default, h as dedupeInFlight, i as ToolbarButton_default, l as ManagesSetMeta_default, m as availableButtons, p as addButtonHtml, u as SetPicker_default, v as Fieldtype_default } from "./index-CaF3D-v6.js";
import { Bn as wrappingInputRule, En as posToDOMRect, G as findChildren, Ht as isNodeEmpty, In as textInputRule, Mt as isAtEndOfNode, Nt as isAtStartOfNode, On as renderNestedMarkdownContent, Rn as textblockTypeInputRule, St as getText, T as canInsertNode, Tt as getTextSerializersFromSchema, Ut as isNodeSelection, Vn as keydownHandler, Vt as isNodeActive, Y as findParentNodeClosestToPos, _n as mergeAttributes, at as getExtensionField, bn as nodeInputRule, ct as getMarkRange, dt as getNodeAtPosition, f as Mark, ht as getRenderedAttributes, m as Node, mn as markPasteRule, mt as getPreviousBlockSibling, pn as markInputRule, pt as getNodeType, rt as getChangedRanges, s as Extension, tt as getAttributes, un as isTextSelection, w as callOrReturn, wn as parseIndentedBlocks } from "./dist-DVqm2P-T.js";
import { i as Fragment$1, p as Slice } from "./dist-D1jI0QqO.js";
import { _ as dropPoint, a as PluginKey, c as TextSelection, i as Plugin, m as Transform, o as Selection$1, r as NodeSelection, s as SelectionRange, u as Mapping } from "./dist-BGVo02xK.js";
import { n as Decoration, r as DecorationSet } from "./view-DKtc-YdG.js";
import { a as NodeViewContent, i as EditorContent, o as NodeViewWrapper, r as Editor, s as VueNodeViewRenderer, t as Set_default } from "./Set-EFB2JDwO.js";
...
var src_default$18 = Node.create({
	name: "blockquote",
	addOptions() {
...
var src_default$17 = Mark.create({
	name: "bold",
	addOptions() {
		return { HTMLAttributes: {} };
	},
...
var src_default$16 = CharacterCount;
//#endregion
...
var src_default$15 = Mark.create({
	name: "code",
	addOptions() {
		return { HTMLAttributes: {} };
	},
...
var src_default$14 = CodeBlock.extend({
	addOptions() {
		var _this$parent;
		return {
...
var src_default$13 = Node.create({
	name: "hardBreak",
...
var src_default$12 = Node.create({
	name: "heading",
	addOptions() {
		return {
			levels: [
...
var src_default$11 = UndoRedo;
var src_default$10 = Node.create({
	name: "horizontalRule",
	addOptions() {
		return {
			HTMLAttributes: {},
...
var src_default$3 = Extension.create({
	name: "textAlign",
	addOptions() {
		return {
			types: [],
...
var src_default$2 = Extension.create({
	name: "typography",
	addOptions() {
		return {
			closeDoubleQuote: "”",
...
var DocumentBlock = src_default.extend({ content: "(block | root)+" });
var DocumentInline = src_default.extend({ content: "paragraph" });
//#endregion
//#region resources/js/components/fieldtypes/bard/Set.js
var Set$1 = Node.create({
	name: "set",
	addNodeView() {
...
var _sfc_main$3 = {
	...
	methods: {
		...
		loadAsset(id) {
			...
			dedupeInFlight("assets-fieldtype", JSON.stringify([id]), () => this.$axios.post(cp_url("assets-fieldtype"), { assets: [id] })).then((response) => {
...
var _sfc_main$2 = {
	...
	computed: {
		...
		typeMeta() {
			if (this.typeMetaOverrides[this.linkType]) return this.typeMetaOverrides[this.linkType];
			const meta = this.registeredLinkType?.meta ?? {};
			return this.selectedTypeData.length ? {
				...meta,
	...
	watch: {
		linkType(type) {
			...
			this.autofocus();
			if (this.registeredLinkType && !this.selectedTypeValue.length) this.$nextTick(() => this.openSelector());
		},
		urlData: {
			deep: true,
			handler() {
...
var _hoisted_2$1 = { class: "flex-1 min-w-0 link-fieldtype" };
var _hoisted_3$1 = { class: "space-y-5" };
	...
	return openBlock(), createElementBlock(Fragment, null, [createVNode(_component_StackContent, { class: "space-y-5" }, {
		default: withCtx(() => [
			createBaseVNode("section", _hoisted_1$2, [createVNode(_component_ui_select, {
				...
				"placeholder",
				"onKeydown"
			])) : $options.registeredLinkType ? (openBlock(), createBlock(resolveDynamicComponent($options.registeredLinkTypeComponent), {
				key: 3,
				ref: "typeField",
				config: $options.registeredLinkType.config,
				meta: $options.typeMeta,
				value: $options.selectedTypeValue,
				"onUpdate:value": $options.typeSelected,
				"onUpdate:meta": $options.typeMetaUpdated
			}, null, 40, [
				"config",
				"meta",
				"value",
			...
			createBaseVNode("section", _hoisted_3$1, [
				$data.linkType === "entry" ? (openBlock(), createBlock(_component_ui_input, {
					...
					"onUpdate:modelValue": _cache[4] || (_cache[4] = ($event) => $data.appends = $event),
				...
				createVNode(_component_ui_input, {
					...
					ref: "input",
					modelValue: $data.rel,
					"onUpdate:modelValue": _cache[6] || (_cache[6] = ($event) => $data.rel = $event),
					prepend: _ctx.__("Rel"),
				...
				createBaseVNode("div", _hoisted_4$1, [createVNode(_component_ui_switch, {
					modelValue: $data.targetBlank,
					"onUpdate:modelValue": _cache[7] || (_cache[7] = ($event) => $data.targetBlank = $event)
		...
		_: 1
			...
			createVNode(_component_ui_button, {
				onClick: _cache[8] || (_cache[8] = ($event) => _ctx.$emit("canceled")),
				text: _ctx.__("Cancel"),
				variant: "ghost"
			}, null, 8, ["text"]),
			createVNode(_component_ui_button, {
...
async function tiptap_default() {
	const [core, vue3, state, model, view] = await Promise.all([
		__vitePreload(() => import("./dist-DVqm2P-T.js").then((n) => n.B), __vite__mapDeps([0,1,2,3,4]), import.meta.url),
		__vitePreload(() => import("./Set-EFB2JDwO.js").then((n) => n.c), __vite__mapDeps([5,6,1,7,8,9,10,11,12,13,14,15,0,2,3,4]), import.meta.url),
		__vitePreload(() => import("./state-CfMmplvw.js").then((n) => n.t), __vite__mapDeps([16,1,4,3]), import.meta.url),
		__vitePreload(() => import("./model-hNPyj5Wv.js").then((n) => n.t), __vite__mapDeps([17,1,3]), import.meta.url),
		__vitePreload(() => import("./view-DKtc-YdG.js").then((n) => n.t), __vite__mapDeps([2,1,3,4]), import.meta.url)
	]);
	return {
		core,
		vue3,
...
var _sfc_main = {
	...
	async mounted() {
		...
		if (this.config.reading_time) this.html = this.editor.getHTML();
	...
	methods: {
		...
		*/
		...
		async pasteSet(attrs) {
			...
			if (meta) this.updateSetMeta(id, meta);
			else {
		...
		withoutSetValues(nodes) {
			return nodes.map((node) => {
				...
				if (node.content) return {
					...node,
					content: this.withoutSetValues(node.content)
				};
				return node;
			});
		},
		getExtensions() {
			let modeExts = this.inputIsInline ? [DocumentInline] : [DocumentBlock, src_default$13];
			if (this.inputIsInline && this.config.inline_hard_breaks) modeExts.push(src_default$13.extend({ addKeyboardShortcuts() {
				return {
					...this.parent?.(),
			...
			let exts = [
				src_default$16.configure({ limit: this.config.character_limit }),
				...modeExts,
				DisableCtrlEnter,
			...
			if (this.config.smart_typography) exts.push(src_default$2);
			let btns = this.buttons.map((button) => button.name);
			if (btns.includes("anchor")) exts.push(Link.configure({ vm: this }));
			if (btns.includes("bold")) exts.push(src_default$17);
			if (btns.includes("code")) exts.push(src_default$15);
			if (btns.includes("codeblock")) exts.push(src_default$14.configure({ lowlight }));
			if (btns.includes("horizontalrule")) exts.push(src_default$10);
			if (btns.includes("image")) exts.push(Image.configure({ bard: this }));
			if (btns.includes("italic")) exts.push(src_default$9);
			if (btns.includes("quote")) exts.push(src_default$18);
			...
			if (btns.includes("underline")) exts.push(src_default$1);
			if (btns.includes("unorderedlist")) exts.push(BulletList);
			if (btns.includes("small")) exts.push(Small);
			if (btns.includes("strikethrough")) exts.push(src_default$7);
			if (btns.includes("subscript")) exts.push(src_default$6);
			if (btns.includes("superscript")) exts.push(src_default$5);
			let levels = [];
			...
			if (levels.length) exts.push(src_default$12.configure({ levels }));
			...
			if (alignments.length) exts.push(src_default$3.configure({
