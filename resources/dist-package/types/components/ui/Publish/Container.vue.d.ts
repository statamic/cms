...
import { injectContainerContext } from './context.js';
import { provideContainerContext } from './context.js';
import { containerContextKey } from './context.js';
declare const __VLS_export: __VLS_WithSlots<import("vue").DefineComponent<import("vue").ExtractPropTypes<{
    ...
    meta: import("vue").Ref<Record<string, any>, Record<string, any>>;
    saving: () => void;
    saved: () => void;
