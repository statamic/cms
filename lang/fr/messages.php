...
return [
    ...
    'collection_entries_reorder_out_of_date' => 'La liste des entrées n’est plus à jour. Actualisez la page et essayez de réordonner.',
    ...
    'field_conditions_reserve_space_when_hidden_instructions' => 'Lorsqu’il est masqué, réservez l’espace du champ dans la mise en page.',
    ...
    'globals_configure_layout_mode_instructions' => 'Choisissez la disposition des champs lors de la modification de ce jeu de globales.',
    ...
    'oauth_already_connected' => 'Votre compte :provider est déjà connecté.',
    'oauth_belongs_to_another_user' => 'Ce compte :provider est déjà associé à un autre utilisateur.',
    'oauth_connect_unsupported' => 'Ce fournisseur ne prend pas en charge la connexion de comptes.',
    'oauth_connected' => 'Votre compte :provider a été connecté.',
    'oauth_disconnected' => 'Votre compte :provider a été déconnecté.',
    'oauth_email_exists' => 'Un compte associé à cette adresse e-mail existe déjà. Connectez-vous et associez ce fournisseur depuis les paramètres de votre compte.',
    ...
    'preference_theme_instructions' => 'Personnalisez les couleurs et l’apparence du Panneau de configuration.',
    ...
    'site_configure_name_instructions' => 'Nom du site affiché dans le Panneau de configuration.',
