...
return [
    ...
    'any_of' => 'Ceci est invalide.',
    'array' => 'Doit être un tableau.',
    'array_keys' => 'Peut uniquement contenir les clefs suivantes : :values.',
    'ascii' => 'Peut uniquement contenir des symboles et caractères alphanumériques mono-bits.',
    'base64' => 'Doit être une chaîne Base64 valide.',
    ...
    'contains' => 'Il manque une valeur obligatoire.',
    ...
    'doesnt_contain' => 'Ne doit contenir aucun des éléments suivants : :values.',
    ...
    'hex_color' => 'Doit être une couleur hexadécimale valide.',
    'image' => 'Doit être une image.',
    'in' => 'Ceci est invalide.',
    'in_array' => 'Ce champ n’existe pas dans :other.',
    'in_array_keys' => 'Doit contenir au moins l’une des clefs suivantes : :values.',
    ...
    'password.letters' => 'Doit contenir au moins une lettre.',
    'password.mixed' => 'Doit contenir au moins une lettre majuscule et une lettre minuscule.',
    'password.numbers' => 'Doit contenir au moins un chiffre.',
    'password.symbols' => 'Doit contenir au moins un symbole.',
    'password.uncompromised' => 'Cette valeur est apparue dans une fuite de données. Veuillez en choisir une autre.',
    'present' => 'Doit être présent.',
    'present_if' => 'Doit être présent lorsque :other est :value.',
    'present_unless' => 'Doit être présent sauf si :other est :value.',
    'present_with' => 'Doit être présent lorsque :value est présent(e).',
    'present_with_all' => 'Doit être présent lorsque :values sont présent(e)s.',
    'prohibited' => 'Interdit.',
    'prohibited_if' => 'Interdit quand :other correspond à :value.',
    'prohibited_if_accepted' => 'Interdit lorsque :other est accepté.',
    'prohibited_if_declined' => 'Interdit lorsque :other est refusé.',
    'prohibited_unless' => 'Interdit à moins que :other soit dans :values.',
    ...
    'required_with_all' => 'Ce champ est obligatoire lorsque :values sont présent(e)s.',
    'required_without' => 'Ce champ est obligatoire lorsque :values n’est pas présent(e).',
    'required_without_all' => 'Ce champ est obligatoire lorsqu’aucun(e) des :values n’est présent(e).',
    ...
    'bard_container_required_by_button' => 'Ce champ est requis par un bouton de la barre d’outils.',
