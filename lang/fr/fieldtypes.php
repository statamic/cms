...
return [
    ...
    'array.config.compact' => 'Affichez un élément déclencheur et modifiez des valeurs dans une fenêtre contextuelle. Utile pour les tableaux et autres mises en page compactes.',
    'array.config.expand' => 'Indique s’il faut enregistrer le tableau au format développé. Utilisez cette option si vous souhaitez avoir des valeurs numériques.',
    ...
    'bard.config.inline_hard_breaks' => 'Permet d’ajouter des sauts de ligne au contenu.',
    ...
    'bard.config.previews' => 'Affichez-les quand les ensembles sont réduits.',
    ...
    'checkboxes.config.appearance' => 'Choisissez comment les cases à cocher seront affichées.',
    ...
    'code.config.line_numbers' => 'Affichez les numéros de ligne dans la marge de l’éditeur de code.',
    'code.config.line_wrapping' => 'Autorisez les longues lignes à s’enrouler jusqu’à la ligne suivante au lieu de défiler horizontalement.',
    'code.config.mode' => 'Choisissez le langage pour la coloration syntaxique.',
    'code.config.mode_selectable' => 'Indique si le mode peut être changé par l’utilisateur.',
    ...
    'code.config.show_mode_label' => 'Indique si l’étiquette du mode doit être affichée.',
    'code.title' => 'Code',
    ...
    'date.config.timezone' => 'Le fuseau horaire dans lequel les dates seront affichées et saisies. Le fuseau horaire par défaut (Auto) est celui du navigateur.',
    'date.title' => 'Date',
    ...
    'dictionary.file.config.label' => 'La clef contenant les libellés des options. Par défaut, c’est `label`. Alternativement, vous pouvez utiliser Antlers.',
    'dictionary.file.config.value' => 'La clef contenant les valeurs des options. Par défaut, c’est `value`.',
    ...
    'entries.config.select_across_sites' => 'Autoriser la sélection d’entrées à partir d’autres sites. Cela désactive également les options de localisation sur le frontal. Pour en savoir plus, consultez la [documentation](https://statamic.dev/fieldtypes/entries#select-across-sites).',
    ...
    'html.config.sanitize_instruct' => 'Indique si le code HTML doit être nettoyé avant d’être affiché. Ne désactivez cette option que si vous avez une bonne raison.',
    'html.title' => 'HTML',
    'icon.config.mode' => 'Choisissez un menu déroulant ou un sélecteur compact.',
    'icon.config.set' => 'Le nom d’un ensemble d’icônes personnalisé.',
    'icon.title' => 'Icon',
    ...
    'link.config.default_option' => 'L’option de type de lien par défaut, si elle est disponible pour la configuration du type de champ.',
    'link.title' => 'Link',
    ...
    'radio.config.appearance' => 'Choisissez le mode d’affichage des boutons radio.',
    ...
    'replicator.config.previews' => 'Affichez-les quand les ensembles sont réduits.',
    ...
    'width.config.size' => 'Choisissez entre les tailles d’interface utilisateur "Grande" et "Par défaut".',
    'width.title' => 'Width',
    'yaml.title' => 'YAML',
];
