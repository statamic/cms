...
return [
    ...
    'asset_container_chunked_uploads_instructions' => 'Split large uploads into smaller chunks to get past PHP and proxy upload size limits. The maximum size is governed by your validation rules (e.g. a `max` rule); uploads are unlimited without one.',
