...
return [
    ...
    'field_conditions_always_save_instructions' => 'Always save the field value, even if the field is hidden.',
    ...
    'form_configure_email_bcc_instructions' => 'Email address of the BCC recipient(s).',
    'form_configure_email_cc_instructions' => 'Email address of the CC recipient(s).',
    ...
    'form_configure_email_to_instructions' => 'Email address of the recipient(s).',
    ...
    'form_fake_submissions_none_to_delete' => 'No fake submissions to delete.',
    'form_fake_submissions_partial_delete' => ':success/:total fake submissions were deleted.',
