...
return [
    ...
    'fields_revisable_instructions' => 'Include this field in revisions. When disabled, changes are saved straight to the published entry instead of a working copy. Only applies to top level fields in collection entries. The date, slug and published fields are unaffected.',
    ...
    'form_export_filtered_description' => 'Exports only the submissions matching the current search and filters.',
