...
return [
    ...
    'assets.config.folder' => 'Specify the initial directory.',
    'assets.config.max_files' => 'Set a maximum number of selectable assets.',
    'assets.config.min_files' => 'Set a minimum number of selectable assets.',
    'assets.config.mode' => 'Choose your preferred UI layout.',
    ...
    'bard.config.enable_input_rules' => 'Automatically format Markdown-style shortcuts while typing (e.g., \*\*bold\*\* becomes **bold**).',
    'bard.config.enable_paste_rules' => 'Automatically format Markdown-style shortcuts when pasting text (e.g., \*\*bold\*\* becomes **bold**).',
    'bard.config.fullscreen' => 'Enable toggle for fullscreen mode.',
    'bard.config.inline' => 'Disable all block-level elements like headings, images, and sets.',
    'bard.config.inline_hard_breaks' => 'Allows adding line breaks to the content.',
    ...
    'code.config.line_numbers' => 'Display line numbers in the code editor gutter.',
    'code.config.line_wrapping' => 'Allow long lines to wrap to the next line instead of scrolling horizontally.',
    ...
    'markdown.config.folder' => 'Specify the initial directory.',
    ...
    'replicator.config.button_label' => 'Customize the label of the "Add Set" button.',
    ...
    'replicator.config.sets' => 'Sets are configurable blocks of fields that can be created and reordered as desired.',
    'replicator.title' => 'Replicator',
    'revealer.config.input_label' => 'Customize the label of the "Show Fields" button, or the label beside the toggle.',
    ...
    'template.config.blueprint' => 'Adds a "map to blueprint" option. Learn more in the [docs](https://statamic.dev/views#map-templates-to-entry-blueprints).',
    ...
    'terms.config.create' => 'Allow users to create new taxonomy terms directly from this field.',
    'terms.config.query_scopes' => 'Query scopes can be applied to the selectable term results. Learn more in the [docs](https://statamic.dev/extending/query-scopes-and-filters).',
    'terms.config.taxonomies' => 'Select which taxonomies to display terms from.',
