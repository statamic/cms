...
return [
    ...
    'collection_configure_layout_instructions' => 'Angi standardlayout for denne samlingen. Oppføringer kan overstyre denne innstillingen med et `template`-felt med navnet `layout`. Det er ikke vanlig å endre denne innstillingen.',
    ...
    'collection_configure_template_instructions' => 'Angi standardmal for denne samlingen. Oppføringer kan overstyre denne innstillingen med et `template`-felt.',
    ...
    'collections_preview_target_refresh_instructions' => 'Oppdater forhåndsvisningen automatisk under redigering. Hvis dette deaktiveres, vil postMessage bli brukt.',
    ...
    'dictionaries_countries_emojis_instructions' => 'Om flaggemojier skal inkluderes i etikettene.',
    'dictionaries_countries_region_instructions' => 'Filtrer eventuelt landene etter region.',
    'duplicate_action_localizations_confirmation' => 'Denne oppføringen er en lokalisering. Den opprinnelige oppføringen vil bli duplisert.',
    'duplicate_action_warning_localization' => 'Én eller flere valgte oppføringer er lokaliseringer. I slike tilfeller vil den opprinnelige oppføringen bli duplisert i stedet.',
    'duplicate_action_warning_localizations' => 'Er du sikker på at du vil utføre denne handlingen? Lokaliseringer vil også bli duplisert.',
    ...
    'field_conditions_field_instructions' => 'Du kan skrive inn hvilken som helst feltreferanse. Du er ikke begrenset til alternativene i nedtrekksmenyen.',
    'field_conditions_instructions' => 'Når dette feltet skal vises eller skjules.',
    'field_desynced_from_origin' => 'Avsynkronisert fra opprinnelse. Klikk for å synkronisere og gå tilbake til opprinnelsesverdien.',
    ...
    'fields_replicator_preview_instructions' => 'Kontroller forhåndsvisningssynlighet i Replicator/Bard-sett.',
    'fields_sortable_instructions' => 'Kontroller om feltet skal være sorterbart i listevisninger.',
    ...
    'filters_view_already_exists' => 'En visning med dette navnet eksisterer allerede. Oppretting av denne visningen vil overskrive den eksisterende visningen med dette navnet.',
    ...
    'form_create_description' => 'Kom i gang ved å opprette ditt første skjema.',
    ...
    'form_configure_email_bcc_instructions' => 'E-postadresse til BCC mottaker(e) - kommaseparert.',
    'form_configure_email_cc_instructions' => 'E-postadresse til CC mottaker(e) - kommaseparert.',
    'form_configure_email_description' => 'Sørg for at e-postinnstillingene dine er konfigurert for å sende og motta varsler når skjemaer sendes.',
    ...
    'form_configure_honeypot_instructions' => 'Feltnavn som skal brukes som en honningkrukke. En honningkrukke er et spesielt felt som brukes for å redusere botspam.',
    ...
    'form_configure_mailer_instructions' => 'Velg maileren for å sende denne e-posten. La stå tomt for å falle tilbake til standard mailer.',
    ...
    'global_next_steps_create_description' => 'Kom i gang ved å opprette ditt første globale sett.',
    ...
    'impersonate_action_confirmation' => 'Du vil være logget inn som denne brukeren. Du kan gå tilbake til kontoen din ved å bruke avatar-menyen.',
    ...
    'navigation_configure_select_across_sites' => 'Tillat å velge oppføringer fra andre nettsteder.',
    ...
    'outpost_license_key_error' => 'Statamic kunne ikke dekryptere den angitte lisensnøkkelfilen. Vennligst last ned på nytt fra statamic.com.',
    ...
    'site_configure_attributes_instructions' => 'Legg til vilkårlige attributter i nettstedets konfigurasjon som kan få tilgang til i malene dine.  [Les mer](https://statamic.dev/multi-site#additional-attributes).',
    'site_configure_handle_instructions' => 'En unik referanse til dette nettstedet. Ikke enkelt å endre senere.',
    ...
    'taxonomies_preview_target_refresh_instructions' => 'Oppdater forhåndsvisningen automatisk under redigering. Hvis dette deaktiveres, vil postMessage bli brukt.',
    ...
    'taxonomy_configure_layout_instructions' => 'Angi standardoppsettet for denne taksonomien. Termer kan overstyre denne innstillingen med et `layout`-felt.',
    'taxonomy_configure_template_instructions' => 'Sett taksonomiens standardmal',
    'taxonomy_configure_term_template_instructions' => 'Angi standardmalen for denne taksonomien. Termer kan overstyre denne innstillingen med et `mal`-felt.',
    'taxonomy_configure_title_instructions' => 'Vi anbefaler et substantiv i flertall, for eksempel "Kategorier" eller "Merker".',
    'taxonomy_next_steps_blueprints_description' => 'Administrer malene og feltene tilgjengelige for denne taksonomien.',
    ...
    'units.ms' => ':countms',
    'units.s' => ':counts',
    'updater_require_version_command' => 'For å kreve en bestemt versjon, kjør følgende kommando',
    'updater_update_to_latest_command' => 'For å oppdatere til siste versjon, kjør følgende kommando',
    'uploader_append_timestamp' => 'Legg til tidsstempel',
    'uploader_choose_new_filename' => 'Velg nytt filnavn',
    'uploader_discard_use_existing' => 'Kast og bruk eksisterende fil',
    'uploader_overwrite_existing' => 'Overskriv eksisterende fil',
    'user_activation_email_not_sent_error' => 'Aktiverings-e-posten kunne ikke sendes. Vennligst sjekk e-postkonfigurasjonen din og prøv igjen.',
