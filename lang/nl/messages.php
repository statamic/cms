...
return [
    ...
    'addon_install_command' => 'Om deze addon te installeren, voer je het volgende commando uit',
    'addon_list_loading_error' => 'Er is iets misgegaan bij het laden van add-ons. Probeer het later opnieuw.',
    'addon_uninstall_command' => 'Om deze addon te verwijderen, voer je het volgende commando uit',
    ...
    'collection_configure_icon_instructions' => 'Kies een icoon voor deze collectie.',
    ...
    'collections_preview_target_refresh_instructions' => 'Vernieuw de preview automatisch tijdens het bewerken. Als je dit uitzet wordt postMessage gebruikt.',
    ...
    'crop_save_as_copy_confirm' => 'De bijgesneden afbeelding opslaan als nieuwe kopie?',
    'crop_save_copy_or_replace' => 'Wil je dit opslaan als nieuwe kopie of de originele afbeelding vervangen?',
    ...
    'disable_two_factor_authentication_other_user_enforced' => 'Ze zullen per direct uitgelogd worden en moeten bij de volgende keer inloggen opnieuw tweestapsverificatie instellen.',
    'disable_two_factor_authentication_other_user_optional' => 'Deze actie zal zowel de verificatie- als herstelcodes ongeldig maken en zal volledige toegang toestaan tot het account met slechts het wachtwoord.',
    'duplicate_action_localizations_confirmation' => 'Weet je zeker dat je deze actie wilt uitvoeren? Alle lokalisaties worden dan ook gedupliceerd.',
    'duplicate_action_warning_localization' => 'Deze entry is een lokalisatie. De originele entry zal worden gedupliceerd.',
    'duplicate_action_warning_localizations' => 'Één of meer van deze entries zijn lokalisaties. In die gevallen zal het origineel gedupliceerd worden.',
    'elevated_session_enter_password' => 'Vanwege veiligheidsreden, graag jouw wachtwoord invoeren om door te gaan.',
    'elevated_session_enter_verification_code' => 'Vanwege veiligheidsreden, graag de verificatiecode die verstuurd is naar jouw e-mailadres invoeren om door te gaan.',
    'elevated_session_reauthenticate' => 'Vanwege veiligheidsredenen, graag opnieuw authenticeren.',
    'elevated_session_required' => 'Een wachtwoordbevestiging is noodzakelijk om door te gaan.',
    'elevated_session_verification_code_notification_body' => 'Kopieer en plak de code die hieronder getoond wordt om je identiteit te bevestigen. Heb je niet verzocht om deze code? Negeer deze e-mail dan.',
    'elevated_session_verification_code_notification_subject' => 'Jouw verificatiecode',
    'elevated_session_verification_code_sent' => 'Verificatiecode verzonden naar jouw e-mailadres.',
    ...
    'field_validation_sometimes_instructions' => 'Alleen valideren wanneer dit veld zichtbaar is of wordt verzonden.',
    'fields_actions_instructions' => 'Toon of verberg de veldactiemogelijkheden, zoals volledig scherm-modus.',
    ...
    'fields_layout_instructions' => 'Toon het veld onder het label of er naast.',
    ...
    'fields_sortable_instructions' => 'Bepaal of het veld sorteerbaar moet zijn in lijstweergaven.',
    ...
    'forgot_password_sent' => 'Als er een account bestaat met dat e-mailadres, is er een wachtwoordresetlink verstuurd.',
    ...
    'form_configure_email_description' => 'Zorg ervoor dat de e-mailinstellingen zijn geconfigureerd om er zeker van te zijn dat notificaties kunnen worden verstuurd en ontvangen als er een antwoord op een formulier wordt ingestuurd.',
    ...
    'form_configure_mailer_instructions' => 'Kies de mailer voor het versturen van deze mail. Laat leeg om de standaard mailer te gebruiken.',
    ...
    'form_create_description' => 'Start door het maken van jouw eerste formulier.',
    ...
    'global_next_steps_create_description' => 'Start door het maken van jouw eerste globalset.',
    ...
    'impersonate_action_confirmation' => 'U wordt ingelogd als deze gebruiker. U kunt terugkeren naar uw account via het avatarmenu.',
    ...
    'navigation_configure_select_across_sites' => 'U kunt items van andere sites selecteren.',
    ...
    'passkeys_browser_unsupported' => 'Passkeys worden niet ondersteund. Zorg ervoor dat je https en een compatibele browser gebruikt.',
    'passkeys_configure_intro' => 'Passkeys bieden een veiligere, wachtwoordloze authenticatie-ervaring.',
    'password_passkeys_only' => 'Log in met je passkey',
    ...
    'preference_confirm_dirty_navigation_instructions' => 'Of je wel of niet een waarschuwing moet zien als je een pagina verlaat met onopgeslagen veranderingen.',
    'preference_contrast' => 'Kies je contrastniveau. Dit zal voornamelijk het contrast van formulierranden verhogen.',
    'preference_favorites_instructions' => 'Snelkoppelingen die getoond worden bij het openen van de algemene zoekbalk. Je kunt ook de pagina bezoeken en het pin-pictogram bovenaan de pagina gebruiken om deze toe te voegen aan de lijst.',
    'preference_locale_instructions' => 'De voorkeurstaal voor het Control Panel.',
    'preference_theme_instructions' => 'Pas de kleuren en het uiterlijk van het Control Panel aan.',
    'preference_start_page_instructions' => 'De pagina die moet worden weergegeven na het inloggen op het Control Panel.',
    'preference_strict_accessibility_instructions' => 'We hebben het control panel met toegankelijkheid in ogenschouw ontworpen, bedoeld om aan de WCAG 2.2 richtlijnen te voldoen waar mogelijk. Activeer deze optie om strictere toegankelijkheidsregels toe te passen door de contrast van formulierranden te verhogen.',
    ...
    'search_with_count_filters_applied' => 'Zoek (1 filter toegepast)|Zoek (:count filters toegepast)',
    'selections_click_to_deselect_all' => 'Alle :total items zijn geselecteerd. Vink uit om alle items te deselecteren.',
    'selections_click_to_select_all' => 'Geen items geselecteerd. Vink aan om alle :total items te selecteren..',
    'selections_item_selected' => ':title is momenteel geselecteerd. Klik om te deselecteren.',
    'selections_item_unselected' => ':title is niet geselecteerd. Klik om te selecteren.',
    'selections_limit_reached' => 'Selectie limiet bereikt. Kan :title niet selecteren',
    'selections_select_all' => ':selected van :total items geselecteerd. Vink aan om alle items te selecteren.',
    'session_expiry_enter_password' => 'Voer je wachtwoord in om verder te gaan waar je gebleven was',
    'session_expiry_enter_two_factor_code' => 'Voer jouw verificatiecode in om door te gaan.',
    'session_expiry_enter_two_factor_recovery_code' => 'Voer een herstelcode in om door te gaan.',
    ...
    'set_new_password_instructions' => 'Bevestig je e-mailadres en maak een nieuw wachtwoord.',
    ...
    'sync_entry_field_confirmation_text' => 'Weet je het zeker? De waarde van dit veld zal vervangen worden door de waarde in de oorspronkelijke entry.',
    'sync_term_field_confirmation_text' => 'Weet je het zeker? De waarde van dit veld zal vervangen worden door de waarde in de oorspronkelijke term.',
    ...
    'taxonomies_preview_target_refresh_instructions' => 'Vernieuw de preview automatisch tijdens het bewerken. Als je dit uitschakelt, wordt de preview alleen vernieuwd als je op de knop klikt.',
    ...
    'taxonomy_configure_layout_instructions' => 'Configureer de standaard layout van deze taxonomie. Termen kunnen deze overschrijven door het instellen van een `layout` veld.',
    ...
    'theme_share_instructions' => 'Publiceer dit thema via je statamic.com-account om het beschikbaar te maken voor anderen.',
    'try_again_in_seconds' => '{0,1} Probeer het nu opnieuw. Probeer het over :count seconden.',
    'try_again_in_minutes' => 'Probeer opnieuw in een minuut.|Probeer het opnieuw in :count minuten.',
    'two_factor_account_requirement' => 'Jouw account moet tweestapsverificatie gebruiken. Schakel dat in voor dat je verder gaat.',
    'two_factor_challenge_code_instructions' => 'Voer de zescijferige code van jouw tweestapsverificatie-app in om in te loggen in jouw account.',
    'two_factor_enable_introduction' => 'Wanneer ingeschakeld, zul je steeds gevraagd om een veilige, willekeurige code van jouw tweestapsverificatie-app wanneer je inlogt.',
    'two_factor_enabled' => 'Tweestapsverificatie ingesteld voor jouw account. Je zult vanaf nu steeds gevraagd worden om een veilige, willekeurige code van jouw tweestapsverificatie-app wanneer je inlogt.',
    'two_factor_not_setup' => 'Deze gebruiker heeft nog geen tweestapsverificatie ingesteld.',
    'two_factor_recovery_code_instructions' => 'Gelieve een van jouw herstelcodes in te voeren om toegang tot jouw account te bevestigen.',
    'two_factor_recovery_codes' => 'Sla je herstelcodes op een veilige plaats op. Ze kunnen worden gebruikt om in te loggen op jouw account als je de toegang tot jouw tweestapsverificatie-app bent verloren.',
    'two_factor_regenerate_recovery_codes' => 'Hergenereren van jouw herstelcodes, zal de voorgaande herstelcodes per direct ongeldig maken.',
    'two_factor_setup_instructions' => 'Scan de QR-code met je authenticator-app of voer handmatig de tekstcode in. Daarna voer je de zescijferige verificatiecode in.',
    'units.B' => ':count B',
    'units.GB' => ':count GB',
    'units.KB' => ':count KB',
    'units.MB' => ':count MB',
    ...
    'uploader_append_timestamp' => 'Tijdstempel toevoegen',
    'uploader_choose_new_filename' => 'Kies een nieuwe bestandsnaam',
    'uploader_discard_use_existing' => 'Bestaand bestand verwijderen en gebruiken',
    'uploader_overwrite_existing' => 'Bestaand bestand overschrijven',
