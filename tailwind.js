...
var colors = {
    ...
    'blue-darker':   '#1c2021',
    'blue-dark':     '#2d393c',
    'blue':          'hsla(200, 70%, 50%, 1)',
    'blue-light':    '#5b6b80',
    'bg-dark':       'hsla(210, 40%, 92%, 1)',
    'bg':            'hsla(210, 40%, 96%, 1)', // @todo rename more descriptively
    'bg-light':      '#f8fafc',
    'bg-lighter':    '#fafcff',
    'black':         '#000000',
    'grey-darkest':  'hsla(210, 10%, 8%, 1)',
    'grey-darker':   'hsla(210, 10%, 15%, 1)',
    'grey-dark':     'hsla(210, 10%, 30%, 1)',
    'grey':          'hsla(210, 10%, 50%, 1)',
    'grey-light':    'hsla(210, 10%, 65%, 1)',
    'grey-lighter':  'hsla(210, 15%, 80%, 1)',
    'grey-lightest': 'hsla(210, 25%, 90%, 1)',
    'green':         '#479967',
    'red':           '#E75650',
    'yellow':        '#fbfab0',
    'yellow-dark':   '#d8cd1b',
