...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        collect(['amp', 'api', 'assets', 'cp', 'forms', 'protect', 'routes', 'search', 'static_caching', 'sites', 'stache', 'system', 'theming', 'users'])->each(function ($config) {
        ...
        $this->publishes([
            "{$this->root}/resources/dist" => public_path('vendor/statamic')
        ], 'statamic-cp');
